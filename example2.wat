...
;; Array Operations
   ...
   (export "power_SM" (func $power_SM))
	...
	(func $example2_S (param $b_f64 f64)
		(local $a_f64 f64)(local $a_i32 i32)(local $mc_t3_f64 f64)(local $mc_t2_f64 f64)(local $mc_t6_i32 i32)(local $mc_t7_i32 i32)(local $mc_t5_i32 i32)
		f64.const 2.0
		set_local $a_f64
		get_local $a_f64
		call $disp_S
	...
	(export "example2_S" (func $example2_S ) )
)
