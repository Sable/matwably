...
(func $return1_S (param $e_f64 f64)
	(local $mc_t895_f64 f64)(local $a_f64 f64)(local $b_f64 f64)(local $c_f64 f64)(local $mc_t899_i32 i32)(local $mc_t900_f64 f64)(local $mc_t901_i32 i32)(local $mc_t902_i32 i32)
	get_local $e_f64
	call $return1_helper_S
	tee_local $mc_t901_i32
	get_local $mc_t901_i32
	i32.const 1
	call $get_array_index_f64
	set_local $a_f64
	get_local $mc_t901_i32
	...
	get_local $e_f64
	call $return1_helper_S
	set_local $mc_t895_f64
	get_local $mc_t895_f64
	call $disp_S
	get_local $e_f64
	call $return1_helper_S
	tee_local $mc_t902_i32
	get_local $mc_t902_i32
	i32.const 1
	call $get_array_index_f64
	set_local $a_f64
	get_local $mc_t902_i32
...
(func $return1_helper_S (param $e_f64 f64)(result i32)
	(local $a_f64 f64)(local $b_f64 f64)(local $c_f64 f64)(local $mc_t903_i32 i32)(local $mc_t904_f64 f64)(local $mc_t905_i32 i32)
	f64.const 3.0
	set_local $a_f64
	f64.const 10.0
	set_local $b_f64
	...
	i32.const 0
	call $create_mxvector
	set_local $mc_t905_i32
	get_local $mc_t905_i32
	i32.const 0
	get_local $a_f64
	call $set_array_index_f64_no_check
	get_local $mc_t905_i32
