...
(func $gcRecordFreeing (param i32)
...
)(func $return1_S (param $e_f64 f64)
	(local $a_f64 f64)(local $b_f64 f64)(local $c_f64 f64)(local $mc_t482_f64 f64)(local $mc_t486_i32 i32)(local $mc_t487_f64 f64)(local $mc_t488_i32 i32)(local $mc_t489_i32 i32)
	get_local $e_f64
	call $return1_helper_S
	tee_local $mc_t488_i32
	...
	get_local $e_f64
	call $return1_helper_S
	set_local $mc_t482_f64
	get_local $mc_t482_f64
	call $disp_S
	get_local $e_f64
	call $return1_helper_S
	tee_local $mc_t489_i32
...
(func $return1_helper_S (param $e_f64 f64)(result i32)
	(local $a_f64 f64)(local $b_f64 f64)(local $c_f64 f64)(local $mc_t490_i32 i32)(local $mc_t491_f64 f64)(local $mc_t492_i32 i32)
	f64.const 3.0
	set_local $a_f64
	f64.const 10.0
	set_local $b_f64
...
(export "return1_S" (func $return1_S ) )
(export "return1_helper_S" (func $return1_helper_S ) )
