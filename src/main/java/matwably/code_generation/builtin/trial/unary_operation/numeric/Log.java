...
public class Log extends UnaryOp {
     ...
     */
    public Log(ASTNode node, TIRCommaSeparatedList arguments, TIRCommaSeparatedList targs, String callName, MatWablyFunctionInformation analyses) {
    ...
    public void generateScalarCall() {
        result.addInstruction(new Call(new Idx("log_S")));
    }
}
