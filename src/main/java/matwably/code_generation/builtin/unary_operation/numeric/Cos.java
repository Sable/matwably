...
public class Cos extends UnaryOp {
     ...
     */
    public Cos(ASTNode node, TIRCommaSeparatedList arguments, TIRCommaSeparatedList targs, String callName, MatWablyFunctionInformation analyses) {
    ...
    public MatWablyBuiltinGeneratorResult generateScalarCall() {
        ...
        result.addInstruction(new Call(new Idx("cos_S")));
        return result;
