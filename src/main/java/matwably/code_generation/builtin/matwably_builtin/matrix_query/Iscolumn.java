...
public class Iscolumn extends LogicalProperty {
    /**
     ...
     */
    public Iscolumn(ASTNode node, TIRCommaSeparatedList arguments, TIRCommaSeparatedList targs, String callName, MatWablyFunctionInformation analyses) {
    ...
    protected boolean shapeHasProperty(Shape shape) {
        return shape!=null && shape.isColVector();
    }
