...
public class Sqrt extends UnaryOp {
     ...
     */
    public Sqrt(ASTNode node, TIRCommaSeparatedList arguments, TIRCommaSeparatedList targs, String callName, MatWablyFunctionInformation analyses) {
    ...
    public MatWablyBuiltinGeneratorResult generateScalarCall() {
        ...
        result.addInstruction(new Call(new Idx("sqrt_S")));
        return result;
    }
}
