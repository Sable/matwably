...
public class Exp extends UnaryOp {
     ...
     */
    public Exp(ASTNode node, TIRCommaSeparatedList arguments, TIRCommaSeparatedList targs, String callName, MatWablyFunctionInformation analyses) {
    ...
    public MatWablyBuiltinGeneratorResult generateScalarCall() {
        ...
        result.addInstruction(new Call(new Idx("exp_S")));
        return result;
    }
}
