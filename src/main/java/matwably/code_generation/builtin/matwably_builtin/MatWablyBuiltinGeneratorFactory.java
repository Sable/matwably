...
import matwably.code_generation.builtin.matwably_builtin.binary_op.logical.*;
import matwably.code_generation.builtin.matwably_builtin.binary_op.logical.bitwise.And;
import matwably.code_generation.builtin.matwably_builtin.binary_op.numerical.*;
import matwably.code_generation.builtin.matwably_builtin.concatanation.Cat;
import matwably.code_generation.builtin.matwably_builtin.concatanation.Horzcat;
import matwably.code_generation.builtin.matwably_builtin.concatanation.Vertcat;
import matwably.code_generation.builtin.matwably_builtin.constant.E;
import matwably.code_generation.builtin.matwably_builtin.constant.False;
import matwably.code_generation.builtin.matwably_builtin.constant.Pi;
import matwably.code_generation.builtin.matwably_builtin.constant.True;
import matwably.code_generation.builtin.matwably_builtin.constructors.*;
import matwably.code_generation.builtin.matwably_builtin.matrix_operation.*;
import matwably.code_generation.builtin.matwably_builtin.matrix_query.*;
import matwably.code_generation.builtin.matwably_builtin.reduction_operation.NumericReduction;
import matwably.code_generation.builtin.matwably_builtin.unary_operation.logical.Not;
import matwably.code_generation.builtin.matwably_builtin.unary_operation.numeric.*;
import matwably.code_generation.builtin.matwably_builtin.utility.Disp;
import matwably.code_generation.builtin.matwably_builtin.utility.Tic;
import matwably.code_generation.builtin.matwably_builtin.utility.Toc;
...
public class MatWablyBuiltinGeneratorFactory {
     ...
     static{
        ...
        // Constants
         ...
         // Matrix ops
         matwablyGeneratorMap.put("subsasgn", Subsasng.class);
         matwablyGeneratorMap.put("subsref", Subsref.class);
         matwablyGeneratorMap.put("end", End.class);
