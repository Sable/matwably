package matwably.code_generation.builtin.binary_op.logical;

import ast.ASTNode;
import matwably.code_generation.MatWablyFunctionInformation;
import matwably.ast.F64;
import matwably.code_generation.builtin.MatWablyBuiltinGeneratorResult;
import matwably.code_generation.builtin.binary_op.LogicalBinaryOp;
import natlab.tame.tir.TIRCommaSeparatedList;

public class Gt  extends LogicalBinaryOp {
    /**
     ...
     */
    public Gt(ASTNode node, TIRCommaSeparatedList arguments,
    ...
    public MatWablyBuiltinGeneratorResult generateScalarCall() {
        ...
        result.addInstruction(new matwably.ast.Gt(new F64(), true));
        return result;
    }
}
