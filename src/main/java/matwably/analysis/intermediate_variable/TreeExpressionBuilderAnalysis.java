...
public class TreeExpressionBuilderAnalysis extends TIRAbstractNodeCaseHandler {
     ...
     */
    private Collection<AssignStmt> redundant_stmts = new HashSet<>();
    ...
    /**
     * UseDefDefUseChain for the program obtained from ReachingDefinitions
     */
     ...
     * @return Returns HashMap of aliased names in the program
     */
    public Collection<AssignStmt> getRedundantStmts() {
    ...
    public void analyze(){
        if(!this.analysisDone){
            ...
            redundant_stmts = new HashSet<>(use_expr_map.values());
        }
     ...
     * @param defs ReachingDefinitions analysis
     * @param mod_vars  ModfiedVariableAnalysis, modified version of reaching definitions
     */
    public TreeExpressionBuilderAnalysis(TIRFunction function,
                          ReachingDefs defs,
                          ModifiedArrayAnalysis mod_vars) {
    ...
    //TODO Manage function calls correctly
//    @Override
//    public void caseTIRAbstractAssignToListStmt(TIRAbstractAssignToListStmt tirStmt){
//
...
//                    && isVariableUntouchedBeforeAnyUse(targetName, tirStmt)){
//
