...
)(func $get_range_expr_S (param $a_f64 f64)
	(local $d_i32 i32)(local $mc_t83_f64 f64)(local $mc_t70_f64 f64)(local $mc_t65_i32 i32)(local $mc_t67_f64 f64)(local $mc_t91_f64 f64)(local $mc_t87_f64 f64)(local $mc_t74_f64 f64)(local $mc_t76_f64 f64)(local $mc_t71_f64 f64)(local $e_i32 i32)(local $mc_t93_f64 f64)(local $mc_t80_f64 f64)(local $h_i32 i32)(local $mc_t66_f64 f64)(local $mc_t79_f64 f64)(local $mc_t84_f64 f64)(local $mc_t62_f64 f64)(local $mc_t75_f64 f64)(local $mc_t88_f64 f64)(local $mc_t64_i32 i32)(local $k_i32 i32)(local $mc_t59_i32 i32)(local $mc_t94_f64 f64)(local $g_i32 i32)(local $mc_t85_f64 f64)(local $mc_t78_f64 f64)(local $l_i32 i32)(local $mc_t61_i32 i32)(local $mc_t72_f64 f64)(local $mc_t63_i32 i32)(local $o_i32 i32)(local $mc_t82_f64 f64)(local $c_i32 i32)(local $mc_t90_f64 f64)(local $mc_t95_f64 f64)(local $b_i32 i32)(local $mc_t60_f64 f64)(local $mc_t97_i32 i32)(local $mc_t98_f64 f64)(local $mc_t100_i32 i32)(local $mc_t99_i32 i32)(local $mc_t101_i32 i32)(local $mc_t102_i32 i32)(local $mc_t103_i32 i32)(local $mc_t105_i32 i32)(local $mc_t107_i32 i32)(local $mc_t106_i32 i32)(local $mc_t112_i32 i32)(local $mc_t108_i32 i32)(local $mc_t113_i32 i32)(local $mc_t110_i32 i32)(local $mc_t109_i32 i32)(local $mc_t111_i32 i32)(local $mc_t114_i32 i32)(local $mc_t117_i32 i32)(local $mc_t119_i32 i32)(local $mc_t115_i32 i32)(local $mc_t116_i32 i32)(local $mc_t121_i32 i32)(local $mc_t120_i32 i32)(local $mc_t118_i32 i32)(local $mc_t122_i32 i32)(local $mc_t123_i32 i32)(local $mc_t124_i32 i32)(local $mc_t125_i32 i32)
	f64.const 2.0
	f64.const 2.0
	call $rand_2D
	set_local $c_i32
...
(export "get_range_expr_S" (func $get_range_expr_S ) )
