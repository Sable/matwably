...
;; Array Operations
   ...
   (export "power_SM" (func $power_SM))
	...
	(func $drv_capr_S (param $scale_f64 f64)
		(local $mc_t0_f64 f64)(local $rel_f64 f64)(local $mc_t10_f64 f64)(local $d_f64 f64)(local $a_f64 f64)(local $mc_t13_f64 f64)(local $mc_t8_f64 f64)(local $n_f64 f64)(local $mc_t2_f64 f64)(local $mc_t4_f64 f64)(local $tol_f64 f64)(local $mc_t6_f64 f64)(local $cap_f64 f64)(local $mc_t1_f64 f64)(local $b_f64 f64)(local $mc_t14_f64 f64)(local $t_f64 f64)(local $c_f64 f64)(local $mc_t3_f64 f64)(local $mc_t12_f64 f64)(local $mc_t9_f64 f64)(local $i_f64 f64)(local $mc_t7_f64 f64)(local $mc_t5_f64 f64)(local $mc_t187_i32 i32)(local $mc_t189_i32 i32)(local $mc_t192_i32 i32)
		f64.const 0.3257463
		set_local $mc_t1_f64
		f64.const 2.0
		set_local $mc_t2_f64
	...
	(func $linspace_SSS (param $d1_f64 f64)(param $d2_f64 f64)(param $n_f64 f64)(result i32)
		(local $mc_t180_i32 i32)(local $mc_t185_f64 f64)(local $mc_t174_i32 i32)(local $mc_t182_f64 f64)(local $mc_t176_f64 f64)(local $mc_t181_f64 f64)(local $mc_t178_i32 i32)(local $mc_t183_f64 f64)(local $y_i32 i32)(local $mc_t184_f64 f64)(local $mc_t177_i32 i32)(local $mc_t179_f64 f64)(local $mc_t175_f64 f64)(local $mc_t197_i32 i32)(local $mc_t196_i32 i32)(local $mc_t195_i32 i32)(local $mc_t199_i32 i32)(local $mc_t198_i32 i32)
		get_local $d1_f64
		...
		set_local $mc_t196_i32
		get_local $mc_t195_i32
		i32.const 0
		get_local $mc_t196_i32
		call $set_array_index_i32_no_check
		get_local $mc_t182_f64
		call $convert_scalar_to_mxarray
		set_local $mc_t197_i32
		get_local $mc_t195_i32
		i32.const 1
		get_local $mc_t197_i32
		call $set_array_index_i32_no_check
		get_local $mc_t195_i32
		call $colon
	...
	(func $capacitor_SSSSSSS (param $a_f64 f64)(param $b_f64 f64)(param $c_f64 f64)(param $d_f64 f64)(param $n_f64 f64)(param $tol_f64 f64)(param $rel_f64 f64)(result f64)
		(local $mc_t58_f64 f64)(local $x_i32 i32)(local $mc_t40_f64 f64)(local $iter_f64 f64)(local $mc_t24_f64 f64)(local $mc_t31_f64 f64)(local $mc_t59_f64 f64)(local $mc_t57_f64 f64)(local $mc_t41_f64 f64)(local $y_i32 i32)(local $mc_t66_f64 f64)(local $mc_t32_f64 f64)(local $mc_t23_f64 f64)(local $mc_t49_f64 f64)(local $na_f64 f64)(local $mc_t51_f64 f64)(local $oldcap_f64 f64)(local $mc_t64_f64 f64)(local $ii_f64 f64)(local $mc_t48_f64 f64)(local $mc_t18_f64 f64)(local $h_f64 f64)(local $mc_t50_f64 f64)(local $mc_t20_f64 f64)(local $mc_t22_f64 f64)(local $mc_t52_f64 f64)(local $mc_t33_f64 f64)(local $mc_t46_f64 f64)(local $mc_t65_f64 f64)(local $mc_t16_f64 f64)(local $mc_t29_f64 f64)(local $mc_t47_f64 f64)(local $mc_t34_f64 f64)(local $mc_t21_f64 f64)(local $jj_f64 f64)(local $mc_t45_f64 f64)(local $mc_t28_f64 f64)(local $mc_t53_f64 f64)(local $mc_t61_f64 f64)(local $mc_t35_i32 i32)(local $mc_t37_f64 f64)(local $mc_t27_f64 f64)(local $mc_t63_f64 f64)(local $cap_f64 f64)(local $mc_t19_f64 f64)(local $mc_t44_f64 f64)(local $mc_t54_f64 f64)(local $mc_t36_f64 f64)(local $mc_t62_f64 f64)(local $mask_i32 i32)(local $mc_t26_f64 f64)(local $mc_t39_f64 f64)(local $mc_t56_f64 f64)(local $f_i32 i32)(local $mc_t42_f64 f64)(local $mb_f64 f64)(local $mc_t38_f64 f64)(local $mc_t55_f64 f64)(local $mc_t43_f64 f64)(local $mc_t25_f64 f64)(local $mc_t30_f64 f64)(local $m_f64 f64)(local $mc_t60_f64 f64)(local $mc_t200_i32 i32)(local $mc_t201_i32 i32)(local $mc_t202_i32 i32)(local $mc_t204_i32 i32)(local $mc_t206_i32 i32)(local $mc_t209_i32 i32)(local $mc_t212_i32 i32)(local $mc_t215_i32 i32)(local $mc_t217_i32 i32)(local $mc_t220_i32 i32)(local $mc_t223_i32 i32)(local $mc_t226_i32 i32)(local $mc_t228_i32 i32)(local $mc_t231_i32 i32)(local $mc_t234_i32 i32)
		f64.const 0.5
		...
		get_local $mc_t201_i32
		call $ones
		set_local $mc_t35_i32
		get_local $rel_f64
		set_local $mc_t36_f64
		get_local $mc_t35_i32
		...
		f64.const 0.0
		set_local $oldcap_f64
		f64.const 1.0
		set_local $mc_t65_f64
		f64.const 1000.0
		set_local $mc_t66_f64
		loop $loop_mc_t235
			get_local $mc_t234_i32
			if 
				get_local $iter_f64
				f64.const 1.0
				f64.add
	...
	(func $seidel_MMSSSS (param $f_i32 i32)(param $mask_i32 i32)(param $n_f64 f64)(param $m_f64 f64)(param $na_f64 f64)(param $mb_f64 f64)(result i32)
		(local $mc_t168_f64 f64)(local $mc_t125_f64 f64)(local $mc_t150_f64 f64)(local $mc_t108_f64 f64)(local $mc_t133_f64 f64)(local $mc_t142_f64 f64)(local $mc_t117_f64 f64)(local $mc_t141_f64 f64)(local $mc_t159_f64 f64)(local $mc_t109_f64 f64)(local $mc_t91_f64 f64)(local $mc_t124_f64 f64)(local $mc_t107_f64 f64)(local $mc_t126_f64 f64)(local $mc_t151_f64 f64)(local $mc_t100_f64 f64)(local $mc_t93_f64 f64)(local $mc_t169_f64 f64)(local $mc_t143_f64 f64)(local $mc_t116_f64 f64)(local $mc_t160_f64 f64)(local $mc_t92_f64 f64)(local $mc_t134_f64 f64)(local $mc_t119_f64 f64)(local $mc_t149_f64 f64)(local $ii_f64 f64)(local $mc_t106_f64 f64)(local $mc_t94_f64 f64)(local $mc_t165_f64 f64)(local $mc_t135_f64 f64)(local $mc_t152_f64 f64)(local $mc_t148_f64 f64)(local $mc_t122_f64 f64)(local $mc_t167_f64 f64)(local $mc_t105_f64 f64)(local $mc_t170_f64 f64)(local $mc_t140_f64 f64)(local $mc_t95_f64 f64)(local $mc_t118_f64 f64)(local $mc_t153_f64 f64)(local $mc_t166_f64 f64)(local $mc_t171_f64 f64)(local $mc_t136_f64 f64)(local $mc_t110_f64 f64)(local $mc_t123_f64 f64)(local $mc_t120_f64 f64)(local $jj_f64 f64)(local $mc_t155_f64 f64)(local $mc_t96_f64 f64)(local $mc_t103_f64 f64)(local $mc_t111_f64 f64)(local $mc_t154_f64 f64)(local $mc_t146_f64 f64)(local $mc_t172_f64 f64)(local $mc_t89_f64 f64)(local $mc_t139_f64 f64)(local $mc_t163_f64 f64)(local $mc_t137_f64 f64)(local $mc_t156_f64 f64)(local $mc_t113_f64 f64)(local $mc_t130_f64 f64)(local $mc_t129_f64 f64)(local $mc_t104_f64 f64)(local $mc_t97_f64 f64)(local $mc_t147_f64 f64)(local $mc_t112_f64 f64)(local $mc_t173_f64 f64)(local $mc_t164_f64 f64)(local $mc_t121_f64 f64)(local $mc_t138_f64 f64)(local $mc_t144_f64 f64)(local $mc_t101_f64 f64)(local $mc_t99_f64 f64)(local $mc_t114_f64 f64)(local $f_i32 i32)(local $mc_t131_f64 f64)(local $mc_t157_f64 f64)(local $mc_t128_f64 f64)(local $mc_t98_f64 f64)(local $mc_t161_f64 f64)(local $mc_t132_f64 f64)(local $mc_t90_f64 f64)(local $mc_t115_f64 f64)(local $mc_t145_f64 f64)(local $mc_t158_f64 f64)(local $mc_t102_f64 f64)(local $mc_t127_f64 f64)(local $mc_t162_f64 f64)(local $mc_t237_i32 i32)(local $mc_t239_i32 i32)(local $mc_t241_i32 i32)(local $mc_t244_i32 i32)(local $mc_t247_i32 i32)(local $mc_t250_i32 i32)(local $mc_t252_i32 i32)(local $mc_t255_i32 i32)(local $mc_t258_i32 i32)(local $mc_t261_i32 i32)(local $mc_t263_i32 i32)(local $mc_t266_i32 i32)(local $mc_t269_i32 i32)(local $mc_t271_i32 i32)(local $mc_t274_i32 i32)(local $mc_t277_i32 i32)(local $mc_t279_i32 i32)(local $mc_t282_i32 i32)
		f64.const 2.0
	...
	(func $gauss_SSSM (param $n_f64 f64)(param $m_f64 f64)(param $h_f64 f64)(param $f_i32 i32)(result f64)
		(local $jj_f64 f64)(local $mc_t83_f64 f64)(local $mc_t70_f64 f64)(local $mc_t67_f64 f64)(local $mc_t87_f64 f64)(local $mc_t74_f64 f64)(local $mc_t76_f64 f64)(local $mc_t71_f64 f64)(local $cap_f64 f64)(local $mc_t80_f64 f64)(local $mc_t79_f64 f64)(local $mc_t84_f64 f64)(local $mc_t75_f64 f64)(local $mc_t88_f64 f64)(local $ii_f64 f64)(local $mc_t81_f64 f64)(local $mc_t69_f64 f64)(local $mc_t85_f64 f64)(local $mc_t78_f64 f64)(local $mc_t72_f64 f64)(local $mc_t82_f64 f64)(local $q_f64 f64)(local $mc_t68_f64 f64)(local $mc_t73_f64 f64)(local $mc_t77_f64 f64)(local $mc_t86_f64 f64)(local $mc_t285_i32 i32)(local $mc_t287_i32 i32)(local $mc_t290_i32 i32)(local $mc_t293_i32 i32)(local $mc_t295_i32 i32)(local $mc_t298_i32 i32)
		f64.const 0.0
		set_local $q_f64
		f64.const 1.0
	...
	(export "drv_capr_S" (func $drv_capr_S ) )
	(export "linspace_SSS" (func $linspace_SSS ) )
	(export "capacitor_SSSSSSS" (func $capacitor_SSSSSSS ) )
	(export "seidel_MMSSSS" (func $seidel_MMSSSS ) )
	(export "gauss_SSSM" (func $gauss_SSSM ) )
)
