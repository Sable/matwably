...
;; Array Operations
   ...
   (export "power_SM" (func $power_SM))
	...
	(func $collatz_S (param $n_f64 f64)(result f64)
		(local $mc_t10_f64 f64)(local $mc_t13_f64 f64)(local $mc_t15_f64 f64)(local $mc_t8_f64 f64)(local $n_f64 f64)(local $y_f64 f64)(local $mc_t11_f64 f64)(local $mc_t4_f64 f64)(local $mc_t6_f64 f64)(local $mc_t14_f64 f64)(local $mc_t12_f64 f64)(local $mc_t9_f64 f64)(local $mc_t7_f64 f64)
		f64.const 0.0
		set_local $y_f64
		f64.const 1.0
	...
	(func $drv_collatz_S (param $scale_f64 f64)
		(local $mc_t1_f64 f64)(local $t_f64 f64)(local $max_num_f64 f64)(local $max_length_f64 f64)(local $i_f64 f64)(local $mc_t2_f64 f64)(local $length_f64 f64)(local $mc_t18_i32 i32)(local $mc_t20_i32 i32)(local $mc_t23_i32 i32)
		f64.const 0.0
	...
	(export "drv_collatz_S" (func $drv_collatz_S ) )
)
