...
;; Array Operations
   ...
   (export "power_SM" (func $power_SM))
	...
	(func $tridiagonal_MMMMS (param $A_i32 i32)(param $D_i32 i32)(param $C_i32 i32)(param $B_i32 i32)(param $n_f64 f64)(result i32)
		(local $k_f64 f64)(local $mc_t120_f64 f64)(local $mc_t125_f64 f64)(local $mc_t108_f64 f64)(local $mc_t96_f64 f64)(local $B_i32 i32)(local $mc_t103_f64 f64)(local $mc_t117_f64 f64)(local $mc_t111_f64 f64)(local $mc_t91_f64 f64)(local $mc_t109_f64 f64)(local $mc_t124_f64 f64)(local $mc_t107_f64 f64)(local $mc_t126_f64 f64)(local $mc_t113_f64 f64)(local $mc_t100_f64 f64)(local $mc_t93_f64 f64)(local $mc_t129_f64 f64)(local $mc_t97_f64 f64)(local $mc_t104_f64 f64)(local $mc_t116_f64 f64)(local $mc_t92_f64 f64)(local $mc_t112_f64 f64)(local $mc_t121_f64 f64)(local $mc_t119_f64 f64)(local $mc_t101_f64 f64)(local $mc_t99_f64 f64)(local $mc_t114_f64 f64)(local $mc_t106_f64 f64)(local $X_i32 i32)(local $mult_f64 f64)(local $D_i32 i32)(local $mc_t94_f64 f64)(local $mc_t128_f64 f64)(local $mc_t98_f64 f64)(local $mc_t122_f64 f64)(local $mc_t105_f64 f64)(local $mc_t115_f64 f64)(local $mc_t95_f64 f64)(local $mc_t102_f64 f64)(local $mc_t118_f64 f64)(local $mc_t127_f64 f64)(local $mc_t110_f64 f64)(local $mc_t123_f64 f64)(local $mc_t130_i32 i32)(local $mc_t133_i32 i32)(local $mc_t134_i32 i32)
		f64.const 2.0
	...
	(func $drv_crni_S (param $scale_f64 f64)
		(local $time_f64 f64)(local $mc_t1_f64 f64)(local $U_i32 i32)(local $a_f64 f64)(local $b_f64 f64)(local $t_f64 f64)(local $c_f64 f64)(local $n_f64 f64)(local $m_f64 f64)(local $mc_t137_i32 i32)(local $mc_t139_i32 i32)(local $mc_t142_i32 i32)
		f64.const 2.5
		set_local $a_f64
		f64.const 1.5
		set_local $b_f64
	...
	(func $crnich_SSSSS (param $a_f64 f64)(param $b_f64 f64)(param $c_f64 f64)(param $n_f64 f64)(param $m_f64 f64)(result i32)
		(local $mc_t83_f64 f64)(local $mc_t40_f64 f64)(local $mc_t24_f64 f64)(local $mc_t67_f64 f64)(local $mc_t59_f64 f64)(local $mc_t57_f64 f64)(local $mc_t14_f64 f64)(local $mc_t32_f64 f64)(local $mc_t75_f64 f64)(local $s1_f64 f64)(local $mc_t49_f64 f64)(local $mc_t37_i32 i32)(local $r_f64 f64)(local $mc_t81_f64 f64)(local $X_i32 i32)(local $mc_t8_f64 f64)(local $mc_t18_f64 f64)(local $mc_t50_f64 f64)(local $mc_t20_f64 f64)(local $mc_t22_f64 f64)(local $mc_t52_f64 f64)(local $mc_t16_f64 f64)(local $mc_t65_f64 f64)(local $mc_t29_f64 f64)(local $mc_t77_f64 f64)(local $mc_t47_f64 f64)(local $mc_t10_f64 f64)(local $mc_t70_f64 f64)(local $mc_t53_f64 f64)(local $U_i32 i32)(local $mc_t61_f64 f64)(local $mc_t35_i32 i32)(local $mc_t89_f64 f64)(local $mc_t4_f64 f64)(local $mc_t87_f64 f64)(local $mc_t6_f64 f64)(local $Va_i32 i32)(local $mc_t27_f64 f64)(local $mc_t63_f64 f64)(local $mc_t19_f64 f64)(local $mc_t44_f64 f64)(local $mc_t80_f64 f64)(local $mc_t36_f64 f64)(local $mc_t79_f64 f64)(local $mc_t85_f64 f64)(local $mc_t42_f64 f64)(local $mc_t72_f64 f64)(local $mc_t38_f64 f64)(local $mc_t68_f64 f64)(local $Vc_i32 i32)(local $mc_t55_f64 f64)(local $mc_t12_f64 f64)(local $mc_t25_f64 f64)(local $mc_t58_f64 f64)(local $mc_t15_f64 f64)(local $mc_t31_f64 f64)(local $mc_t74_f64 f64)(local $mc_t76_f64 f64)(local $mc_t41_f64 f64)(local $mc_t7_i32 i32)(local $mc_t66_f64 f64)(local $mc_t9_f64 f64)(local $mc_t84_f64 f64)(local $mc_t23_f64 f64)(local $mc_t51_f64 f64)(local $mc_t64_f64 f64)(local $mc_t48_f64 f64)(local $h_f64 f64)(local $mc_t78_f64 f64)(local $j1_f64 f64)(local $s2_f64 f64)(local $mc_t33_f64 f64)(local $mc_t82_f64 f64)(local $mc_t46_f64 f64)(local $mc_t17_f64 f64)(local $mc_t21_f64 f64)(local $k_f64 f64)(local $i1_f64 f64)(local $mc_t45_f64 f64)(local $mc_t28_f64 f64)(local $Vb_i32 i32)(local $mc_t11_f64 f64)(local $mc_t71_f64 f64)(local $mc_t54_f64 f64)(local $mc_t34_i32 i32)(local $mc_t62_f64 f64)(local $mc_t88_f64 f64)(local $mc_t26_f64 f64)(local $mc_t5_i32 i32)(local $mc_t39_f64 f64)(local $mc_t56_f64 f64)(local $mc_t13_f64 f64)(local $mc_t69_f64 f64)(local $mc_t90_f64 f64)(local $mc_t3_f64 f64)(local $mc_t73_f64 f64)(local $Vd_i32 i32)(local $mc_t43_f64 f64)(local $mc_t30_f64 f64)(local $mc_t86_f64 f64)(local $mc_t60_f64 f64)(local $mc_t145_i32 i32)(local $mc_t146_i32 i32)(local $mc_t149_i32 i32)(local $mc_t150_i32 i32)(local $mc_t151_i32 i32)(local $mc_t152_i32 i32)(local $mc_t153_i32 i32)(local $mc_t156_i32 i32)(local $mc_t161_i32 i32)(local $mc_t159_i32 i32)(local $mc_t160_i32 i32)(local $mc_t162_i32 i32)(local $mc_t163_i32 i32)
		get_local $a_f64
		set_local $mc_t9_f64
		f64.const 1.0
	...
	(export "tridiagonal_MMMMS" (func $tridiagonal_MMMMS ) )
	(export "drv_crni_S" (func $drv_crni_S ) )
	(export "crnich_SSSSS" (func $crnich_SSSSS ) )
)
