...
;; Array Operations
   ...
   (export "power_SM" (func $power_SM))
	...
	(func $mcpi_p_SS (param $N_f64 f64)(param $P_f64 f64)(result f64)
		(local $mc_t10_f64 f64)(local $mc_t13_f64 f64)(local $mc_t15_f64 f64)(local $mc_t8_f64 f64)(local $mc_t11_f64 f64)(local $y_f64 f64)(local $result_f64 f64)(local $temp_f64 f64)(local $mc_t4_f64 f64)(local $temp2_f64 f64)(local $mc_t6_f64 f64)(local $myRes_f64 f64)(local $mc_t16_f64 f64)(local $mc_t14_f64 f64)(local $mc_t12_f64 f64)(local $mc_t17_f64 f64)(local $x_f64 f64)(local $mc_t9_f64 f64)(local $mc_t7_f64 f64)(local $mc_t18_i32 i32)(local $mc_t21_i32 i32)(local $mc_t25_i32 i32)(local $mc_t24_i32 i32)(local $mc_t27_i32 i32)(local $mc_t26_i32 i32)
		f64.const 0.0
		set_local $result_f64
		f64.const 1.0
			...
			block $block_mc_t20
				...
				loop $loop_mc_t22
					...
					block $block_mc_t23
						...
						i32.const 0
						call $create_mxvector
						set_local $mc_t26_i32
						get_local $mc_t26_i32
						i32.const 0
	...
	(func $drv_mcpi_p_S (param $scale_f64 f64)
		(local $mc_t1_f64 f64)(local $res_f64 f64)(local $t_f64 f64)(local $mc_t2_f64 f64)
		call $tic
		drop 
		f64.const 50000.0
		set_local $mc_t1_f64
	...
	(export "mcpi_p_SS" (func $mcpi_p_SS ) )
	(export "drv_mcpi_p_S" (func $drv_mcpi_p_S ) )
)
