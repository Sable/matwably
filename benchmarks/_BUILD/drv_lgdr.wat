...
;; Array Operations
   ...
   (export "power_SM" (func $power_SM))
	...
	(func $PN_Legendre_vectN_MS (param $x_i32 i32)(param $n_f64 f64)(result i32)
		(local $mc_t45_f64 f64)(local $mc_t21_i32 i32)(local $mc_t28_f64 f64)(local $mc_t53_f64 f64)(local $mc_t18_i32 i32)(local $mc_t40_f64 f64)(local $mc_t15_f64 f64)(local $mc_t24_f64 f64)(local $mc_t22_i32 i32)(local $mc_t31_f64 f64)(local $mc_t37_f64 f64)(local $j_f64 f64)(local $mc_t20_i32 i32)(local $mc_t27_f64 f64)(local $mc_t19_f64 f64)(local $mc_t41_f64 f64)(local $mc_t44_f64 f64)(local $mc_t17_i32 i32)(local $mc_t14_f64 f64)(local $mc_t54_f64 f64)(local $mc_t36_f64 f64)(local $mc_t16_i32 i32)(local $mc_t29_i32 i32)(local $mc_t32_f64 f64)(local $mc_t23_f64 f64)(local $mc_t49_f64 f64)(local $mc_t25_i32 i32)(local $mc_t26_f64 f64)(local $mc_t51_f64 f64)(local $mc_t39_f64 f64)(local $mc_t13_f64 f64)(local $mc_t48_f64 f64)(local $mc_t42_f64 f64)(local $mc_t50_f64 f64)(local $mc_t35_f64 f64)(local $mc_t11_i32 i32)(local $mc_t52_f64 f64)(local $mc_t33_f64 f64)(local $mc_t38_f64 f64)(local $mc_t46_f64 f64)(local $mc_t12_f64 f64)(local $mc_t43_f64 f64)(local $mc_t30_f64 f64)(local $PNa_i32 i32)(local $mc_t47_f64 f64)(local $mc_t9_i32 i32)(local $mc_t10_i32 i32)(local $mc_t34_f64 f64)(local $mc_t175_i32 i32)(local $mc_t178_i32 i32)(local $mc_t176_i32 i32)(local $mc_t177_i32 i32)(local $mc_t179_i32 i32)(local $mc_t181_i32 i32)(local $mc_t182_i32 i32)(local $mc_t180_i32 i32)(local $mc_t183_i32 i32)(local $mc_t186_i32 i32)(local $mc_t187_i32 i32)(local $mc_t188_i32 i32)(local $mc_t189_i32 i32)(local $mc_t191_i32 i32)(local $mc_t190_i32 i32)(local $mc_t192_i32 i32)(local $mc_t194_i32 i32)(local $mc_t193_i32 i32)(local $mc_t195_i32 i32)(local $mc_t200_i32 i32)(local $mc_t198_i32 i32)(local $mc_t199_i32 i32)(local $mc_t203_i32 i32)(local $mc_t201_i32 i32)(local $mc_t202_i32 i32)
		get_local $x_i32
		call $length_M
		...
		i32.const 0
		call $create_mxvector
		set_local $mc_t175_i32
		get_local $mc_t175_i32
		i32.const 0
		...
		i32.const 0
		call $create_mxvector
		set_local $mc_t179_i32
		get_local $mc_t179_i32
		i32.const 0
		...
		i32.const 0
		call $create_mxvector
		set_local $mc_t176_i32
		f64.const 1.0
		f64.const 5
		call $colon_two
		set_local $mc_t177_i32
		get_local $mc_t176_i32
		i32.const 1
		get_local $mc_t177_i32
		call $set_array_index_i32
		get_local $mc_t37_f64
		call $convert_scalar_to_mxarray
		set_local $mc_t178_i32
		get_local $mc_t176_i32
		i32.const 1
		get_local $mc_t178_i32
		...
		if 
			...
			i32.const 0
			call $create_mxvector
			set_local $mc_t180_i32
			f64.const 1.0
			f64.const 5
			call $colon_two
			set_local $mc_t181_i32
			get_local $mc_t180_i32
			i32.const 1
			get_local $mc_t181_i32
			call $set_array_index_i32
			get_local $mc_t38_f64
			call $convert_scalar_to_mxarray
			set_local $mc_t182_i32
			get_local $mc_t180_i32
			i32.const 1
			get_local $mc_t182_i32
			call $set_array_index_i32_no_check
			get_local $PNa_i32
			get_local $mc_t180_i32
			get_local $mc_t9_i32
		...
		if 
			...
			loop $loop_mc_t184
				...
				block $block_mc_t185
					...
					get_local $x_i32
					call $transpose_M
					set_local $mc_t25_i32
					get_local $mc_t24_f64
					get_local $mc_t25_i32
					call $times_SM
					set_local $mc_t21_i32
					f64.const 1.0
					...
					i32.const 0
					call $create_mxvector
					set_local $mc_t186_i32
					f64.const 1.0
					f64.const 5
					call $colon_two
					set_local $mc_t187_i32
					get_local $mc_t186_i32
					i32.const 1
					get_local $mc_t187_i32
					call $set_array_index_i32
					get_local $mc_t23_f64
					call $convert_scalar_to_mxarray
					set_local $mc_t188_i32
					get_local $mc_t186_i32
					i32.const 1
					get_local $mc_t188_i32
					call $set_array_index_i32_no_check
					get_local $PNa_i32
					get_local $mc_t186_i32
					call $get_f64
					set_local $mc_t22_i32
					get_local $mc_t21_i32
					get_local $mc_t22_i32
					call $times_MM
					set_local $mc_t17_i32
					get_local $j_f64
					...
					i32.const 0
					call $create_mxvector
					set_local $mc_t189_i32
					f64.const 1.0
					f64.const 5
					call $colon_two
					set_local $mc_t190_i32
					get_local $mc_t189_i32
					i32.const 1
					get_local $mc_t190_i32
					call $set_array_index_i32
					get_local $j_f64
					call $convert_scalar_to_mxarray
					set_local $mc_t191_i32
					get_local $mc_t189_i32
					i32.const 1
					get_local $mc_t191_i32
					call $set_array_index_i32_no_check
					get_local $PNa_i32
					get_local $mc_t189_i32
					call $get_f64
					...
					call $times_SM
					set_local $mc_t18_i32
					get_local $mc_t17_i32
					get_local $mc_t18_i32
					call $minus_MM
					set_local $mc_t16_i32
					get_local $mc_t15_f64
					get_local $mc_t16_i32
					call $times_SM
					...
					i32.const 0
					call $create_mxvector
					set_local $mc_t192_i32
					f64.const 1.0
					f64.const 5
					call $colon_two
					set_local $mc_t193_i32
					get_local $mc_t192_i32
					i32.const 1
					get_local $mc_t193_i32
					call $set_array_index_i32
					get_local $mc_t12_f64
					call $convert_scalar_to_mxarray
					set_local $mc_t194_i32
					get_local $mc_t192_i32
					i32.const 1
					get_local $mc_t194_i32
					call $set_array_index_i32_no_check
					get_local $PNa_i32
					get_local $mc_t192_i32
		...
		loop $loop_mc_t196
			...
			block $block_mc_t197
				...
				i32.const 0
				call $create_mxvector
				set_local $mc_t198_i32
				f64.const 1.0
				f64.const 5
				call $colon_two
				set_local $mc_t199_i32
				get_local $mc_t198_i32
				i32.const 1
				get_local $mc_t199_i32
				call $set_array_index_i32
				get_local $j_f64
				call $convert_scalar_to_mxarray
				set_local $mc_t200_i32
				get_local $mc_t198_i32
				i32.const 1
				get_local $mc_t200_i32
				call $set_array_index_i32_no_check
				get_local $PNa_i32
				get_local $mc_t198_i32
				call $get_f64
				set_local $mc_t29_i32
				get_local $j_f64
				...
				i32.const 0
				call $create_mxvector
				set_local $mc_t201_i32
				f64.const 1.0
				f64.const 5
				call $colon_two
				set_local $mc_t202_i32
				get_local $mc_t201_i32
				i32.const 1
				get_local $mc_t202_i32
				call $set_array_index_i32
				get_local $j_f64
				call $convert_scalar_to_mxarray
				set_local $mc_t203_i32
				get_local $mc_t201_i32
				i32.const 1
				get_local $mc_t203_i32
				call $set_array_index_i32_no_check
				get_local $PNa_i32
				get_local $mc_t201_i32
	...
	(func $PNxx_Legendre_vectN_MS (param $x_i32 i32)(param $n_f64 f64)(result i32)
		(local $mc_t168_f64 f64)(local $mc_t150_f64 f64)(local $mc_t131_i32 i32)(local $mc_t133_f64 f64)(local $mc_t123_i32 i32)(local $mc_t142_f64 f64)(local $mc_t117_f64 f64)(local $mc_t141_f64 f64)(local $mc_t159_f64 f64)(local $mc_t115_i32 i32)(local $mc_t122_i32 i32)(local $mc_t124_f64 f64)(local $mc_t151_f64 f64)(local $mc_t126_f64 f64)(local $mc_t169_f64 f64)(local $mc_t143_f64 f64)(local $mc_t116_f64 f64)(local $mc_t160_f64 f64)(local $mc_t134_f64 f64)(local $mc_t114_i32 i32)(local $mc_t149_f64 f64)(local $mc_t165_f64 f64)(local $mc_t135_f64 f64)(local $mc_t152_f64 f64)(local $mc_t148_f64 f64)(local $mc_t113_i32 i32)(local $mc_t167_f64 f64)(local $mc_t137_i32 i32)(local $mc_t170_f64 f64)(local $mc_t140_f64 f64)(local $mc_t118_f64 f64)(local $mc_t153_f64 f64)(local $mc_t166_f64 f64)(local $mc_t171_f64 f64)(local $mc_t136_f64 f64)(local $mc_t125_i32 i32)(local $mc_t120_f64 f64)(local $mc_t119_i32 i32)(local $mc_t155_f64 f64)(local $mc_t146_f64 f64)(local $mc_t154_f64 f64)(local $mc_t172_f64 f64)(local $mc_t128_i32 i32)(local $j_f64 f64)(local $mc_t139_f64 f64)(local $mc_t163_f64 f64)(local $mc_t156_f64 f64)(local $mc_t130_f64 f64)(local $mc_t129_f64 f64)(local $mc_t147_f64 f64)(local $mc_t173_f64 f64)(local $mc_t164_f64 f64)(local $mc_t138_f64 f64)(local $PNxxa_i32 i32)(local $mc_t127_i32 i32)(local $mc_t144_f64 f64)(local $mc_t174_f64 f64)(local $mc_t157_f64 f64)(local $mc_t161_f64 f64)(local $mc_t132_f64 f64)(local $mc_t145_f64 f64)(local $mc_t158_f64 f64)(local $mc_t121_i32 i32)(local $mc_t162_f64 f64)(local $mc_t204_i32 i32)(local $mc_t207_i32 i32)(local $mc_t205_i32 i32)(local $mc_t206_i32 i32)(local $mc_t208_i32 i32)(local $mc_t209_i32 i32)(local $mc_t210_i32 i32)(local $mc_t211_i32 i32)(local $mc_t212_i32 i32)(local $mc_t215_i32 i32)(local $mc_t214_i32 i32)(local $mc_t213_i32 i32)(local $mc_t216_i32 i32)(local $mc_t219_i32 i32)(local $mc_t218_i32 i32)(local $mc_t217_i32 i32)(local $mc_t220_i32 i32)(local $mc_t225_i32 i32)(local $mc_t224_i32 i32)(local $mc_t223_i32 i32)(local $mc_t226_i32 i32)(local $mc_t228_i32 i32)(local $mc_t227_i32 i32)(local $mc_t229_i32 i32)(local $mc_t230_i32 i32)(local $mc_t231_i32 i32)(local $mc_t232_i32 i32)(local $mc_t235_i32 i32)(local $mc_t237_i32 i32)(local $mc_t236_i32 i32)(local $mc_t238_i32 i32)(local $mc_t240_i32 i32)(local $mc_t239_i32 i32)
		get_local $x_i32
		call $length_M
		...
		i32.const 0
		call $create_mxvector
		set_local $mc_t204_i32
		get_local $mc_t204_i32
		i32.const 0
		...
		i32.const 0
		call $create_mxvector
		set_local $mc_t208_i32
		get_local $mc_t208_i32
		i32.const 0
		...
		i32.const 0
		call $create_mxvector
		set_local $mc_t205_i32
		f64.const 1.0
		f64.const 5
		call $colon_two
		set_local $mc_t206_i32
		get_local $mc_t205_i32
		i32.const 1
		get_local $mc_t206_i32
		call $set_array_index_i32
		get_local $mc_t145_f64
		call $convert_scalar_to_mxarray
		set_local $mc_t207_i32
		get_local $mc_t205_i32
		i32.const 1
		get_local $mc_t207_i32
		call $set_array_index_i32_no_check
		get_local $PNxxa_i32
		get_local $mc_t205_i32
		get_local $mc_t208_i32
		...
		if 
			...
			i32.const 0
			call $create_mxvector
			set_local $mc_t212_i32
			get_local $mc_t212_i32
			i32.const 0
			...
			i32.const 0
			call $create_mxvector
			set_local $mc_t209_i32
			f64.const 1.0
			f64.const 5
			call $colon_two
			set_local $mc_t210_i32
			get_local $mc_t209_i32
			i32.const 1
			get_local $mc_t210_i32
			call $set_array_index_i32
			get_local $mc_t147_f64
			call $convert_scalar_to_mxarray
			set_local $mc_t211_i32
			get_local $mc_t209_i32
			i32.const 1
			get_local $mc_t211_i32
			call $set_array_index_i32_no_check
			get_local $PNxxa_i32
			get_local $mc_t209_i32
			get_local $mc_t212_i32
		...
		if 
			...
			i32.const 0
			call $create_mxvector
			set_local $mc_t216_i32
			get_local $mc_t216_i32
			i32.const 0
			...
			i32.const 0
			call $create_mxvector
			set_local $mc_t213_i32
			f64.const 1.0
			f64.const 5
			call $colon_two
			set_local $mc_t214_i32
			get_local $mc_t213_i32
			i32.const 1
			get_local $mc_t214_i32
			call $set_array_index_i32
			get_local $mc_t151_f64
			call $convert_scalar_to_mxarray
			set_local $mc_t215_i32
			get_local $mc_t213_i32
			i32.const 1
			get_local $mc_t215_i32
			call $set_array_index_i32_no_check
			get_local $PNxxa_i32
			get_local $mc_t213_i32
			get_local $mc_t216_i32
		...
		if 
			...
			i32.const 0
			call $create_mxvector
			set_local $mc_t217_i32
			f64.const 1.0
			f64.const 5
			call $colon_two
			set_local $mc_t218_i32
			get_local $mc_t217_i32
			i32.const 1
			get_local $mc_t218_i32
			call $set_array_index_i32
			get_local $mc_t155_f64
			call $convert_scalar_to_mxarray
			set_local $mc_t219_i32
			get_local $mc_t217_i32
			i32.const 1
			get_local $mc_t219_i32
			call $set_array_index_i32_no_check
			get_local $PNxxa_i32
			get_local $mc_t217_i32
		...
		if 
			...
			loop $loop_mc_t221
				...
				block $block_mc_t222
					...
					get_local $x_i32
					call $transpose_M
					set_local $mc_t131_i32
					get_local $mc_t130_f64
					get_local $mc_t131_i32
					call $times_SM
					...
					i32.const 0
					call $create_mxvector
					set_local $mc_t223_i32
					f64.const 1.0
					f64.const 5
					call $colon_two
					set_local $mc_t224_i32
					get_local $mc_t223_i32
					i32.const 1
					get_local $mc_t224_i32
					call $set_array_index_i32
					get_local $mc_t129_f64
					call $convert_scalar_to_mxarray
					set_local $mc_t225_i32
					get_local $mc_t223_i32
					i32.const 1
					get_local $mc_t225_i32
					call $set_array_index_i32_no_check
					get_local $PNxxa_i32
					get_local $mc_t223_i32
					call $get_f64
					...
					i32.const 0
					call $create_mxvector
					set_local $mc_t226_i32
					f64.const 1.0
					f64.const 5
					call $colon_two
					set_local $mc_t227_i32
					get_local $mc_t226_i32
					i32.const 1
					get_local $mc_t227_i32
					call $set_array_index_i32
					get_local $mc_t126_f64
					call $convert_scalar_to_mxarray
					set_local $mc_t228_i32
					get_local $mc_t226_i32
					i32.const 1
					get_local $mc_t228_i32
					call $set_array_index_i32_no_check
					get_local $PNxxa_i32
					get_local $mc_t226_i32
					call $get_f64
					...
					call $minus_MM
					set_local $mc_t121_i32
					get_local $mc_t120_f64
					get_local $mc_t121_i32
					call $times_SM
					...
					i32.const 0
					call $create_mxvector
					set_local $mc_t229_i32
					f64.const 1.0
					f64.const 5
					call $colon_two
					set_local $mc_t230_i32
					get_local $mc_t229_i32
					i32.const 1
					get_local $mc_t230_i32
					call $set_array_index_i32
					get_local $mc_t116_f64
					call $convert_scalar_to_mxarray
					set_local $mc_t231_i32
					get_local $mc_t229_i32
					i32.const 1
					get_local $mc_t231_i32
					call $set_array_index_i32_no_check
					get_local $PNxxa_i32
					get_local $mc_t229_i32
		...
		loop $loop_mc_t233
			...
			block $block_mc_t234
				...
				i32.const 0
				call $create_mxvector
				set_local $mc_t235_i32
				f64.const 1.0
				f64.const 5
				call $colon_two
				set_local $mc_t236_i32
				get_local $mc_t235_i32
				i32.const 1
				get_local $mc_t236_i32
				call $set_array_index_i32
				get_local $j_f64
				call $convert_scalar_to_mxarray
				set_local $mc_t237_i32
				get_local $mc_t235_i32
				i32.const 1
				get_local $mc_t237_i32
				call $set_array_index_i32_no_check
				get_local $PNxxa_i32
				get_local $mc_t235_i32
				call $get_f64
				...
				i32.const 0
				call $create_mxvector
				set_local $mc_t238_i32
				f64.const 1.0
				f64.const 5
				call $colon_two
				set_local $mc_t239_i32
				get_local $mc_t238_i32
				i32.const 1
				get_local $mc_t239_i32
				call $set_array_index_i32
				get_local $j_f64
				call $convert_scalar_to_mxarray
				set_local $mc_t240_i32
				get_local $mc_t238_i32
				i32.const 1
				get_local $mc_t240_i32
				call $set_array_index_i32_no_check
				get_local $PNxxa_i32
				get_local $mc_t238_i32
	...
	(func $drv_lgdr_S (param $scale_f64 f64)
		(local $x_i32 i32)(local $n_f64 f64)(local $mc_t2_f64 f64)(local $mc_t4_f64 f64)(local $mc_t1_f64 f64)(local $t_f64 f64)(local $mc_t3_f64 f64)(local $i_f64 f64)(local $mc_t7_f64 f64)(local $PNa_i32 i32)(local $PNxa_i32 i32)(local $mc_t5_f64 f64)(local $PNxxa_i32 i32)(local $mc_t243_i32 i32)(local $mc_t242_i32 i32)(local $mc_t241_i32 i32)(local $mc_t246_i32 i32)(local $mc_t244_i32 i32)(local $mc_t245_i32 i32)(local $mc_t247_i32 i32)(local $mc_t249_i32 i32)(local $mc_t252_i32 i32)
		f64.const 0.0
		set_local $mc_t1_f64
		f64.const 0.3
		set_local $mc_t2_f64
		...
		i32.const 0
		call $create_mxvector
		set_local $mc_t241_i32
		get_local $mc_t1_f64
		call $convert_scalar_to_mxarray
		set_local $mc_t242_i32
		get_local $mc_t241_i32
		i32.const 0
		get_local $mc_t242_i32
		call $set_array_index_i32_no_check
		get_local $mc_t2_f64
		call $convert_scalar_to_mxarray
		set_local $mc_t243_i32
		get_local $mc_t241_i32
		i32.const 1
		get_local $mc_t243_i32
		call $set_array_index_i32_no_check
		get_local $mc_t3_f64
		call $convert_scalar_to_mxarray
		set_local $mc_t244_i32
		get_local $mc_t241_i32
		i32.const 2
		get_local $mc_t244_i32
		call $set_array_index_i32_no_check
		get_local $mc_t4_f64
		call $convert_scalar_to_mxarray
		set_local $mc_t245_i32
		get_local $mc_t241_i32
		i32.const 3
		get_local $mc_t245_i32
		call $set_array_index_i32_no_check
		get_local $mc_t5_f64
		call $convert_scalar_to_mxarray
		set_local $mc_t246_i32
		get_local $mc_t241_i32
		i32.const 4
		get_local $mc_t246_i32
		call $set_array_index_i32_no_check
		get_local $mc_t241_i32
		call $horzcat
		set_local $x_i32
				...
				block 
					block 
						...
						block $block_mc_t248
							...
							get_local $x_i32
							get_local $n_f64
							call $PN_Legendre_vectN_MS
							set_local $PNa_i32
							get_local $x_i32
							get_local $n_f64
							call $PNx_Legendre_vectN_MS
							set_local $PNxa_i32
							get_local $x_i32
							get_local $n_f64
							call $PNxx_Legendre_vectN_MS
							set_local $PNxxa_i32
						end
	...
	(func $PNx_Legendre_vectN_MS (param $x_i32 i32)(param $n_f64 f64)(result i32)
		(local $mc_t56_i32 i32)(local $mc_t58_f64 f64)(local $mc_t83_f64 f64)(local $mc_t108_f64 f64)(local $mc_t73_i32 i32)(local $mc_t65_i32 i32)(local $mc_t91_f64 f64)(local $mc_t109_f64 f64)(local $mc_t59_f64 f64)(local $mc_t74_f64 f64)(local $mc_t107_f64 f64)(local $mc_t76_f64 f64)(local $mc_t55_i32 i32)(local $mc_t93_f64 f64)(local $mc_t100_f64 f64)(local $mc_t92_f64 f64)(local $mc_t66_f64 f64)(local $mc_t84_f64 f64)(local $mc_t75_f64 f64)(local $mc_t64_i32 i32)(local $mc_t81_f64 f64)(local $mc_t106_f64 f64)(local $mc_t94_f64 f64)(local $mc_t70_i32 i32)(local $mc_t78_f64 f64)(local $mc_t67_i32 i32)(local $mc_t82_f64 f64)(local $mc_t105_f64 f64)(local $mc_t95_f64 f64)(local $mc_t77_f64 f64)(local $mc_t110_f64 f64)(local $mc_t79_i32 i32)(local $mc_t69_i32 i32)(local $mc_t96_f64 f64)(local $mc_t103_f64 f64)(local $mc_t111_f64 f64)(local $mc_t89_f64 f64)(local $j_f64 f64)(local $mc_t87_f64 f64)(local $mc_t71_f64 f64)(local $mc_t80_f64 f64)(local $mc_t97_f64 f64)(local $mc_t104_f64 f64)(local $mc_t112_f64 f64)(local $mc_t62_f64 f64)(local $mc_t88_f64 f64)(local $mc_t101_f64 f64)(local $mc_t99_f64 f64)(local $mc_t85_f64 f64)(local $mc_t98_f64 f64)(local $mc_t61_i32 i32)(local $mc_t72_f64 f64)(local $mc_t63_i32 i32)(local $mc_t90_f64 f64)(local $mc_t68_f64 f64)(local $mc_t57_i32 i32)(local $mc_t102_f64 f64)(local $PNxa_i32 i32)(local $mc_t86_f64 f64)(local $mc_t60_f64 f64)(local $mc_t255_i32 i32)(local $mc_t256_i32 i32)(local $mc_t257_i32 i32)(local $mc_t258_i32 i32)(local $mc_t259_i32 i32)(local $mc_t260_i32 i32)(local $mc_t262_i32 i32)(local $mc_t261_i32 i32)(local $mc_t263_i32 i32)(local $mc_t266_i32 i32)(local $mc_t264_i32 i32)(local $mc_t265_i32 i32)(local $mc_t267_i32 i32)(local $mc_t272_i32 i32)(local $mc_t270_i32 i32)(local $mc_t271_i32 i32)(local $mc_t275_i32 i32)(local $mc_t273_i32 i32)(local $mc_t274_i32 i32)(local $mc_t276_i32 i32)(local $mc_t277_i32 i32)(local $mc_t278_i32 i32)(local $mc_t279_i32 i32)(local $mc_t282_i32 i32)(local $mc_t283_i32 i32)(local $mc_t284_i32 i32)(local $mc_t286_i32 i32)(local $mc_t285_i32 i32)(local $mc_t287_i32 i32)
		get_local $x_i32
		call $length_M
		...
		i32.const 0
		call $create_mxvector
		set_local $mc_t255_i32
		get_local $mc_t255_i32
		i32.const 0
		...
		i32.const 0
		call $create_mxvector
		set_local $mc_t259_i32
		get_local $mc_t259_i32
		i32.const 0
		...
		i32.const 0
		call $create_mxvector
		set_local $mc_t256_i32
		f64.const 1.0
		f64.const 5
		call $colon_two
		set_local $mc_t257_i32
		get_local $mc_t256_i32
		i32.const 1
		get_local $mc_t257_i32
		call $set_array_index_i32
		get_local $mc_t87_f64
		call $convert_scalar_to_mxarray
		set_local $mc_t258_i32
		get_local $mc_t256_i32
		i32.const 1
		get_local $mc_t258_i32
		call $set_array_index_i32_no_check
		get_local $PNxa_i32
		get_local $mc_t256_i32
		get_local $mc_t259_i32
		...
		if 
			...
			i32.const 0
			call $create_mxvector
			set_local $mc_t260_i32
			f64.const 1.0
			f64.const 5
			call $colon_two
			set_local $mc_t261_i32
			get_local $mc_t260_i32
			i32.const 1
			get_local $mc_t261_i32
			call $set_array_index_i32
		...
		if 
			...
			loop $loop_mc_t268
				...
				block $block_mc_t269
					...
					get_local $mc_t273_i32
					call $get_f64
					set_local $mc_t67_i32
					get_local $mc_t66_f64
					get_local $mc_t67_i32
					call $times_SM
					set_local $mc_t65_i32
					get_local $mc_t64_i32
					get_local $mc_t65_i32
					call $minus_MM
					...
					f64.const 5
					call $colon_two
					set_local $mc_t277_i32
					get_local $mc_t276_i32
					i32.const 1
					get_local $mc_t277_i32
					call $set_array_index_i32
	...
	(export "PN_Legendre_vectN_MS" (func $PN_Legendre_vectN_MS ) )
	(export "PNxx_Legendre_vectN_MS" (func $PNxx_Legendre_vectN_MS ) )
	(export "drv_lgdr_S" (func $drv_lgdr_S ) )
	(export "PNx_Legendre_vectN_MS" (func $PNx_Legendre_vectN_MS ) )
)
