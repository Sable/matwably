...
;; Array Operations
   ...
   (export "power_SM" (func $power_SM))
	...
	(func $drv_nb1d_S (param $scale_f64 f64)
		(local $mc_t0_f64 f64)(local $Fx_i32 i32)(local $mc_t10_f64 f64)(local $mc_t15_f64 f64)(local $mc_t24_f64 f64)(local $Vz_i32 i32)(local $mc_t11_f64 f64)(local $mc_t27_f64 f64)(local $mc_t1_f64 f64)(local $mc_t19_f64 f64)(local $seed_f64 f64)(local $mc_t14_f64 f64)(local $t_f64 f64)(local $mc_t7_i32 i32)(local $Rx_i32 i32)(local $mc_t9_f64 f64)(local $m_i32 i32)(local $mc_t23_f64 f64)(local $Rz_i32 i32)(local $mc_t5_i32 i32)(local $mc_t26_f64 f64)(local $Vx_i32 i32)(local $dT_f64 f64)(local $mc_t13_f64 f64)(local $n_f64 f64)(local $mc_t8_f64 f64)(local $mc_t18_f64 f64)(local $Fz_i32 i32)(local $mc_t2_f64 f64)(local $mc_t6_i32 i32)(local $mc_t20_f64 f64)(local $mc_t22_f64 f64)(local $mc_t4_i32 i32)(local $Ry_i32 i32)(local $mc_t16_f64 f64)(local $T_f64 f64)(local $Fy_i32 i32)(local $mc_t12_f64 f64)(local $mc_t3_f64 f64)(local $scale_f64 f64)(local $mc_t17_f64 f64)(local $Vy_i32 i32)(local $mc_t25_f64 f64)(local $mc_t21_f64 f64)(local $mc_t89_i32 i32)
		f64.const 1.0
		set_local $seed_f64
		f64.const 4.0
		set_local $scale_f64
	...
	(func $rand1_SSS (param $m_f64 f64)(param $n_f64 f64)(param $seed_f64 f64)(result i32)
		(local $mc_t83_f64 f64)(local $mc_t81_f64 f64)(local $mc_t85_f64 f64)(local $mc_t78_f64 f64)(local $j_f64 f64)(local $mc_t87_f64 f64)(local $mc_t76_f64 f64)(local $mc_t82_f64 f64)(local $seed_f64 f64)(local $mc_t80_f64 f64)(local $i_f64 f64)(local $mc_t84_f64 f64)(local $mc_t79_f64 f64)(local $mc_t77_f64 f64)(local $mc_t86_f64 f64)(local $mc_t75_f64 f64)(local $M_i32 i32)(local $mc_t88_f64 f64)(local $mc_t90_i32 i32)(local $mc_t91_i32 i32)(local $mc_t94_i32 i32)(local $mc_t98_i32 i32)
		get_local $seed_f64
	...
	(func $nbody1d_SMMMMSS (param $n_f64 f64)(param $Rx_i32 i32)(param $Ry_i32 i32)(param $Rz_i32 i32)(param $m_i32 i32)(param $dT_f64 f64)(param $T_f64 f64)(result i32)
		(local $mc_t56_i32 i32)(local $Fx_i32 i32)(local $mc_t67_f64 f64)(local $Vz_i32 i32)(local $mc_t31_f64 f64)(local $mc_t74_f64 f64)(local $mc_t39_i32 i32)(local $mc_t55_i32 i32)(local $mc_t46_i32 i32)(local $mc_t66_f64 f64)(local $Rx_i32 i32)(local $mc_t32_f64 f64)(local $mc_t49_f64 f64)(local $mc_t64_i32 i32)(local $mc_t37_i32 i32)(local $mc_t51_f64 f64)(local $Vx_i32 i32)(local $mc_t41_i32 i32)(local $mc_t48_f64 f64)(local $mc_t50_f64 f64)(local $mc_t54_i32 i32)(local $drz_i32 i32)(local $mc_t52_f64 f64)(local $mc_t65_f64 f64)(local $mc_t53_i32 i32)(local $G_f64 f64)(local $dry_i32 i32)(local $Vy_i32 i32)(local $mc_t40_i32 i32)(local $mc_t47_f64 f64)(local $mc_t34_f64 f64)(local $k_f64 f64)(local $mc_t70_f64 f64)(local $mc_t45_f64 f64)(local $mc_t43_i32 i32)(local $r_i32 i32)(local $mc_t35_i32 i32)(local $drx_i32 i32)(local $ax_i32 i32)(local $mc_t71_f64 f64)(local $mc_t44_f64 f64)(local $mc_t33_i32 i32)(local $mc_t42_i32 i32)(local $t_f64 f64)(local $mc_t36_f64 f64)(local $ay_i32 i32)(local $mc_t60_i32 i32)(local $frz_i32 i32)(local $Rz_i32 i32)(local $mc_t62_i32 i32)(local $f_i32 i32)(local $mc_t58_i32 i32)(local $mc_t69_f64 f64)(local $mc_t59_i32 i32)(local $az_i32 i32)(local $Fz_i32 i32)(local $mc_t61_i32 i32)(local $mc_t72_f64 f64)(local $mc_t63_i32 i32)(local $fry_i32 i32)(local $mc_t38_f64 f64)(local $Ry_i32 i32)(local $mc_t68_f64 f64)(local $Fy_i32 i32)(local $mc_t57_i32 i32)(local $mc_t73_f64 f64)(local $mc_t30_f64 f64)(local $frx_i32 i32)(local $M_i32 i32)(local $mc_t102_i32 i32)(local $mc_t103_i32 i32)(local $mc_t104_i32 i32)(local $mc_t105_i32 i32)(local $mc_t106_i32 i32)(local $mc_t107_i32 i32)(local $mc_t108_i32 i32)(local $mc_t110_i32 i32)(local $mc_t112_i32 i32)(local $mc_t113_i32 i32)(local $mc_t114_i32 i32)(local $mc_t115_i32 i32)(local $mc_t118_i32 i32)(local $mc_t119_i32 i32)(local $mc_t120_i32 i32)(local $mc_t121_i32 i32)(local $mc_t124_i32 i32)(local $mc_t125_i32 i32)(local $mc_t126_i32 i32)(local $mc_t127_i32 i32)(local $mc_t130_i32 i32)(local $mc_t132_i32 i32)(local $mc_t133_i32 i32)(local $mc_t134_i32 i32)(local $mc_t135_i32 i32)(local $mc_t138_i32 i32)(local $mc_t139_i32 i32)(local $mc_t140_i32 i32)(local $mc_t141_i32 i32)(local $mc_t144_i32 i32)(local $mc_t145_i32 i32)(local $mc_t146_i32 i32)(local $mc_t147_i32 i32)(local $mc_t150_i32 i32)(local $mc_t152_i32 i32)(local $mc_t153_i32 i32)(local $mc_t154_i32 i32)(local $mc_t155_i32 i32)(local $mc_t158_i32 i32)(local $mc_t159_i32 i32)(local $mc_t160_i32 i32)(local $mc_t161_i32 i32)(local $mc_t164_i32 i32)(local $mc_t165_i32 i32)(local $mc_t166_i32 i32)(local $mc_t167_i32 i32)
		f64.const 1.0
		...
		i32.const 0
		call $create_mxvector
		set_local $mc_t105_i32
		get_local $mc_t105_i32
		i32.const 0
		get_local $n_f64
		call $set_array_index_f64_no_check
		get_local $mc_t105_i32
				...
				block 
					block 
						...
						block $block_mc_t109
								...
								block 
									block 
										block 
											...
											block $block_mc_t111
												...
												get_local $drz_i32
												call $times_MM
												set_local $mc_t40_i32
												get_local $mc_t39_i32
												get_local $mc_t40_i32
												call $plus_MM
												set_local $r_i32
												f64.const 1.0
									...
									loop $loop_mc_t122
										...
										block $block_mc_t123
											...
											get_local $frz_i32
											call $mean_M
											set_local $mc_t126_i32
											get_local $mc_t126_i32
											i32.const 0
											call $get_array_index_f64_no_check
											set_local $mc_t51_f64
											get_local $n_f64
							...
							get_local $dT_f64
							call $times_MS
							set_local $mc_t60_i32
							get_local $mc_t59_i32
							get_local $mc_t60_i32
							call $plus_MM
							set_local $Rx_i32
							get_local $Ry_i32
							call $clone
									...
									block 
										...
										loop $loop_mc_t136
											...
											block $block_mc_t137
												...
												get_local $frz_i32
												call $mean_M
												set_local $mc_t140_i32
												get_local $mc_t140_i32
												i32.const 0
												call $get_array_index_f64_no_check
												set_local $mc_t51_f64
												get_local $n_f64
							...
							block 
								block 
									block 
										...
										block $block_mc_t151
											...
											get_local $frx_i32
											call $mean_M
											set_local $mc_t152_i32
											get_local $mc_t152_i32
											i32.const 0
											call $get_array_index_f64_no_check
											set_local $mc_t47_f64
											get_local $n_f64
								...
								loop $loop_mc_t162
									...
									block $block_mc_t163
										...
										get_local $frz_i32
										call $mean_M
										set_local $mc_t166_i32
										get_local $mc_t166_i32
										i32.const 0
										call $get_array_index_f64_no_check
										set_local $mc_t51_f64
										get_local $n_f64
	...
	(export "drv_nb1d_S" (func $drv_nb1d_S ) )
	(export "rand1_SSS" (func $rand1_SSS ) )
	(export "nbody1d_SMMMMSS" (func $nbody1d_SMMMMSS ) )
)
