...
(func $rand1_SSS (param $m_f64 f64)(param $n_f64 f64)(param $seed_f64 f64)(result i32)
	(local $mc_t83_f64 f64)(local $mc_t81_f64 f64)(local $mc_t85_f64 f64)(local $mc_t78_f64 f64)(local $j_f64 f64)(local $mc_t87_f64 f64)(local $mc_t76_f64 f64)(local $mc_t82_f64 f64)(local $seed_f64 f64)(local $mc_t80_f64 f64)(local $i_f64 f64)(local $mc_t84_f64 f64)(local $mc_t79_f64 f64)(local $mc_t77_f64 f64)(local $mc_t86_f64 f64)(local $mc_t75_f64 f64)(local $M_i32 i32)(local $mc_t88_f64 f64)(local $mc_t89_i32 i32)(local $mc_t90_f64 f64)(local $mc_t91_f64 f64)
	get_local $seed_f64
...
(func $drv_nb1d_S (param $scale_f64 f64)
	...
	get_local $m_i32
	call $gcSetExternalFlag
	get_local $mc_t95_i32
	tee_local $mc_t97_i32
...
(func $nbody1d_SMMMMSS (param $n_f64 f64)(param $Rx_i32 i32)(param $Ry_i32 i32)(param $Rz_i32 i32)(param $m_i32 i32)(param $dT_f64 f64)(param $T_f64 f64)(result i32)
					...
					block $block_mc_t102
						...
						if $block_mc_t105
							loop $loop_mc_t104
								...
								get_local $Rx_i32
								call $gcCheckExternalToDecreaseRCSite
	...
	get_local $mc_t53_i32
	call $gcCheckReturnFlagToFreeSite
	get_local $mc_t54_i32
	call $gcCheckReturnFlagToFreeSite
	get_local $mc_t55_i32
	call $gcCheckReturnFlagToFreeSite
	...
	call $gcCheckReturnFlagToFreeSite
	get_local $Rx_i32
	call $gcCheckExternalAndReturnFlagToFreeSite
	get_local $mc_t61_i32
	call $gcCheckExternalAndReturnFlagToFreeSite
	get_local $Ry_i32
	call $gcCheckExternalAndReturnFlagToFreeSite
