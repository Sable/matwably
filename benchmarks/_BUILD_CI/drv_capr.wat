...
;; Array Operations
   ...
   (export "power_SM" (func $power_SM))
	...
	(func $linspace_SSS (param $d1_f64 f64)(param $d2_f64 f64)(param $n_f64 f64)(result i32)
		(local $mc_t180_i32 i32)(local $mc_t185_f64 f64)(local $mc_t174_i32 i32)(local $mc_t182_f64 f64)(local $mc_t176_f64 f64)(local $mc_t181_f64 f64)(local $mc_t178_i32 i32)(local $mc_t183_f64 f64)(local $y_i32 i32)(local $mc_t184_f64 f64)(local $mc_t177_i32 i32)(local $mc_t179_f64 f64)(local $mc_t175_f64 f64)(local $mc_t197_i32 i32)(local $mc_t195_i32 i32)(local $mc_t196_i32 i32)(local $mc_t198_i32 i32)(local $mc_t199_i32 i32)
		get_local $d1_f64
