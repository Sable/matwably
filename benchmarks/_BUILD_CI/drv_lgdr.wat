...
;; Array Operations
   ...
   (export "power_SM" (func $power_SM))
	...
	(func $PN_Legendre_vectN_MS (param $x_i32 i32)(param $n_f64 f64)(result i32)
		(local $mc_t45_f64 f64)(local $mc_t21_i32 i32)(local $mc_t28_f64 f64)(local $mc_t53_f64 f64)(local $mc_t18_i32 i32)(local $mc_t40_f64 f64)(local $mc_t15_f64 f64)(local $mc_t24_f64 f64)(local $mc_t22_i32 i32)(local $mc_t31_f64 f64)(local $mc_t37_f64 f64)(local $j_f64 f64)(local $mc_t20_i32 i32)(local $mc_t27_f64 f64)(local $mc_t19_f64 f64)(local $mc_t41_f64 f64)(local $mc_t44_f64 f64)(local $mc_t17_i32 i32)(local $mc_t14_f64 f64)(local $mc_t54_f64 f64)(local $mc_t36_f64 f64)(local $mc_t16_i32 i32)(local $mc_t29_i32 i32)(local $mc_t32_f64 f64)(local $mc_t23_f64 f64)(local $mc_t49_f64 f64)(local $mc_t25_i32 i32)(local $mc_t26_f64 f64)(local $mc_t51_f64 f64)(local $mc_t39_f64 f64)(local $mc_t13_f64 f64)(local $mc_t48_f64 f64)(local $mc_t42_f64 f64)(local $mc_t50_f64 f64)(local $mc_t35_f64 f64)(local $mc_t11_i32 i32)(local $mc_t52_f64 f64)(local $mc_t33_f64 f64)(local $mc_t38_f64 f64)(local $mc_t46_f64 f64)(local $mc_t12_f64 f64)(local $mc_t43_f64 f64)(local $mc_t30_f64 f64)(local $PNa_i32 i32)(local $mc_t47_f64 f64)(local $mc_t9_i32 i32)(local $mc_t10_i32 i32)(local $mc_t34_f64 f64)(local $mc_t175_i32 i32)(local $mc_t178_i32 i32)(local $mc_t177_i32 i32)(local $mc_t176_i32 i32)(local $mc_t179_i32 i32)(local $mc_t182_i32 i32)(local $mc_t181_i32 i32)(local $mc_t180_i32 i32)(local $mc_t183_i32 i32)(local $mc_t187_i32 i32)(local $mc_t188_i32 i32)(local $mc_t186_i32 i32)(local $mc_t190_i32 i32)(local $mc_t191_i32 i32)(local $mc_t189_i32 i32)(local $mc_t192_i32 i32)(local $mc_t193_i32 i32)(local $mc_t194_i32 i32)(local $mc_t195_i32 i32)(local $mc_t200_i32 i32)(local $mc_t199_i32 i32)(local $mc_t198_i32 i32)(local $mc_t201_i32 i32)(local $mc_t202_i32 i32)(local $mc_t203_i32 i32)
		get_local $x_i32
		call $length_M
	...
	(func $drv_lgdr_S (param $scale_f64 f64)
		(local $x_i32 i32)(local $n_f64 f64)(local $mc_t2_f64 f64)(local $mc_t4_f64 f64)(local $mc_t1_f64 f64)(local $t_f64 f64)(local $mc_t3_f64 f64)(local $i_f64 f64)(local $mc_t7_f64 f64)(local $PNa_i32 i32)(local $PNxa_i32 i32)(local $mc_t5_f64 f64)(local $PNxxa_i32 i32)(local $mc_t242_i32 i32)(local $mc_t244_i32 i32)(local $mc_t241_i32 i32)(local $mc_t245_i32 i32)(local $mc_t243_i32 i32)(local $mc_t246_i32 i32)(local $mc_t247_i32 i32)(local $mc_t249_i32 i32)(local $mc_t252_i32 i32)
		f64.const 0.0
		set_local $mc_t1_f64
		f64.const 0.3
		set_local $mc_t2_f64
