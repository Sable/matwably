...
;; Array Operations
   ...
   (export "power_SM" (func $power_SM))
	...
	(func $drv_prime_S (param $scale_f64 f64)
		(local $t_f64 f64)(local $y_f64 f64)
		call $tic
		drop 
		get_local $scale_f64
		call $prime_total_S
	...
	(func $prime_total_S (param $n_f64 f64)(result f64)
		(local $total_f64 f64)(local $prime_f64 f64)(local $mc_t8_f64 f64)(local $i_f64 f64)(local $mc_t2_f64 f64)(local $mc_t7_f64 f64)(local $mc_t4_f64 f64)(local $j_f64 f64)(local $mc_t5_f64 f64)(local $mc_t6_f64 f64)(local $mc_t9_i32 i32)(local $mc_t11_i32 i32)(local $mc_t13_i32 i32)(local $mc_t16_i32 i32)(local $mc_t19_i32 i32)(local $mc_t22_i32 i32)(local $mc_t24_i32 i32)(local $mc_t27_i32 i32)(local $mc_t30_i32 i32)(local $mc_t33_i32 i32)(local $mc_t35_i32 i32)(local $mc_t38_i32 i32)
		f64.const 0.0
		set_local $total_f64
		f64.const 2.0
		set_local $mc_t8_f64
	...
	(export "drv_prime_S" (func $drv_prime_S ) )
	(export "prime_total_S" (func $prime_total_S ) )
)
