...
;; Array Operations
   ...
   (export "power_SM" (func $power_SM))
	...
	(func $make_change_MSS (param $coins_i32 i32)(param $n_f64 f64)(param $amount_f64 f64)(result f64)
		(local $mc_t10_f64 f64)(local $N_f64 f64)(local $mc_t28_f64 f64)(local $mc_t15_f64 f64)(local $mc_t24_f64 f64)(local $mc_t31_f64 f64)(local $mc_t11_f64 f64)(local $j_f64 f64)(local $T_i32 i32)(local $mc_t27_f64 f64)(local $mc_t19_f64 f64)(local $mc_t14_f64 f64)(local $mc_t32_f64 f64)(local $mc_t23_f64 f64)(local $mc_t26_f64 f64)(local $mc_t13_f64 f64)(local $A_f64 f64)(local $mc_t18_f64 f64)(local $ways_f64 f64)(local $mc_t20_f64 f64)(local $mc_t22_f64 f64)(local $mc_t35_f64 f64)(local $left_idx_f64 f64)(local $mc_t33_f64 f64)(local $mc_t16_f64 f64)(local $mc_t29_f64 f64)(local $mc_t12_f64 f64)(local $mc_t17_f64 f64)(local $i_f64 f64)(local $mc_t25_f64 f64)(local $mc_t30_f64 f64)(local $mc_t34_f64 f64)(local $mc_t21_f64 f64)(local $mc_t36_i32 i32)(local $mc_t37_i32 i32)(local $mc_t40_i32 i32)(local $mc_t43_i32 i32)(local $mc_t45_i32 i32)(local $mc_t48_i32 i32)
		f64.const 1.0
						...
						block 
							block 
								...
								block $block_mc_t44
									...
									f64.sub
									set_local $left_idx_f64
									f64.const 0.0
									set_local $mc_t33_f64
									get_local $left_idx_f64
	...
	(func $drv_make_change_S (param $scale_f64 f64)
		(local $mc_t1_f64 f64)(local $coins_i32 i32)(local $t_f64 f64)(local $mc_t3_f64 f64)(local $mc_t8_f64 f64)(local $i_f64 f64)(local $mc_t2_f64 f64)(local $mc_t7_f64 f64)(local $mc_t4_f64 f64)(local $mc_t54_i32 i32)(local $mc_t51_i32 i32)(local $mc_t55_i32 i32)(local $mc_t53_i32 i32)(local $mc_t52_i32 i32)(local $mc_t56_i32 i32)(local $mc_t58_i32 i32)(local $mc_t61_i32 i32)
		f64.const 1.0
		set_local $mc_t1_f64
		f64.const 5.0
		set_local $mc_t2_f64
	...
	(export "make_change_MSS" (func $make_change_MSS ) )
	(export "drv_make_change_S" (func $drv_make_change_S ) )
)
