...
;; Array Operations
   ...
   (export "power_SM" (func $power_SM))
	...
	(func $matmul_p_MMSSS (param $A_i32 i32)(param $B_i32 i32)(param $m_f64 f64)(param $k_f64 f64)(param $n_f64 f64)(result i32)
		(local $mc_t10_f64 f64)(local $c_i32 i32)(local $mc_t13_f64 f64)(local $mc_t14_f64 f64)(local $mc_t12_f64 f64)(local $mc_t8_f64 f64)(local $i_f64 f64)(local $mc_t9_f64 f64)(local $h_f64 f64)(local $mc_t11_f64 f64)(local $mc_t7_f64 f64)(local $j_f64 f64)(local $mc_t15_i32 i32)(local $mc_t16_i32 i32)(local $mc_t19_i32 i32)(local $mc_t22_i32 i32)
		i32.const 2
		i32.const 0
		i32.const 0
		i32.const 0
	...
	(func $drv_matmul_p_S (param $scale_f64 f64)
		(local $k_f64 f64)(local $mc_t0_i32 i32)(local $B_i32 i32)(local $n_f64 f64)(local $A_i32 i32)(local $mc_t2_f64 f64)(local $mc_t4_f64 f64)(local $C_i32 i32)(local $mc_t1_i32 i32)(local $t_f64 f64)(local $mc_t3_f64 f64)(local $scale_f64 f64)(local $m_f64 f64)(local $mc_t25_i32 i32)(local $mc_t26_i32 i32)
		f64.const 100.0
		set_local $scale_f64
		get_local $scale_f64
		set_local $m_f64
	...
	(export "matmul_p_MMSSS" (func $matmul_p_MMSSS ) )
	(export "drv_matmul_p_S" (func $drv_matmul_p_S ) )
)
