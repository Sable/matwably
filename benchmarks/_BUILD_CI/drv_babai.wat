...
;; Array Operations
   ...
   (export "power_SM" (func $power_SM))
	...
	(func $babai_MM (param $R_i32 i32)(param $y_i32 i32)(result i32)
		(local $k_f64 f64)(local $mc_t28_f64 f64)(local $mc_t24_f64 f64)(local $mc_t4_f64 f64)(local $ck_f64 f64)(local $mc_t6_f64 f64)(local $mc_t27_f64 f64)(local $mc_t19_f64 f64)(local $z_hat_i32 i32)(local $mc_t14_f64 f64)(local $mc_t23_f64 f64)(local $mc_t5_f64 f64)(local $mc_t26_f64 f64)(local $mc_t13_f64 f64)(local $n_f64 f64)(local $mc_t8_f64 f64)(local $mc_t18_f64 f64)(local $mc_t15_i32 i32)(local $mc_t20_f64 f64)(local $mc_t22_f64 f64)(local $mc_t11_i32 i32)(local $mc_t16_f64 f64)(local $par_f64 f64)(local $mc_t29_f64 f64)(local $mc_t12_f64 f64)(local $mc_t17_f64 f64)(local $mc_t25_f64 f64)(local $mc_t7_f64 f64)(local $mc_t9_i32 i32)(local $mc_t10_i32 i32)(local $mc_t21_f64 f64)(local $mc_t40_i32 i32)(local $mc_t41_i32 i32)(local $mc_t43_i32 i32)(local $mc_t44_i32 i32)(local $mc_t45_i32 i32)(local $mc_t47_i32 i32)(local $mc_t46_i32 i32)(local $mc_t49_i32 i32)(local $mc_t48_i32 i32)(local $mc_t50_i32 i32)(local $mc_t51_i32 i32)(local $mc_t52_i32 i32)(local $mc_t53_i32 i32)(local $mc_t57_i32 i32)(local $mc_t58_i32 i32)(local $mc_t56_i32 i32)(local $mc_t59_i32 i32)(local $mc_t60_i32 i32)(local $mc_t61_i32 i32)(local $mc_t62_i32 i32)(local $mc_t63_i32 i32)(local $mc_t64_i32 i32)(local $mc_t65_i32 i32)(local $mc_t66_i32 i32)(local $mc_t70_i32 i32)(local $mc_t71_i32 i32)(local $mc_t69_i32 i32)(local $mc_t72_i32 i32)(local $mc_t73_i32 i32)(local $mc_t76_i32 i32)(local $mc_t74_i32 i32)(local $mc_t75_i32 i32)(local $mc_t77_i32 i32)(local $mc_t78_i32 i32)
		get_local $y_i32
		call $length_M
		set_local $n_f64
		f64.const 1.0
