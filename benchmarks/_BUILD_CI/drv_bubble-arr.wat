...
;; Array Operations
   ...
   (export "power_SM" (func $power_SM))
	...
	(func $drv_bubble_S (param $size_f64 f64)
		(local $mc_t0_f64 f64)(local $mc_t1_f64 f64)(local $t_f64 f64)(local $y_i32 i32)(local $mc_t3_f64 f64)(local $A_i32 i32)(local $i_f64 f64)(local $mc_t21_i32 i32)(local $mc_t22_i32 i32)(local $mc_t24_i32 i32)(local $mc_t27_i32 i32)
		f64.const 1.0
		set_local $mc_t0_f64
		i32.const 2
		i32.const 0
	...
	(func $check_arr_limits (param $arr_ptr i32)(param $low f64)(param $high f64)
	    get_local $low
	    f64.const 1
	    f64.lt
	    if
	...
	(func $bubble_M (param $A_i32 i32)(result i32)
		(local $mc_t10_f64 f64)(local $mc_t13_f64 f64)(local $A_i32_ptr i32)(local $x_i32 i32)(local $mc_t15_f64 f64)(local $n_f64 f64)(local $mc_t8_f64 f64)(local $mc_t18_f64 f64)(local $A_i32 i32)(local $mc_t11_f64 f64)(local $mc_t20_f64 f64)(local $j_f64 f64)(local $temp_f64 f64)(local $mc_t6_f64 f64)(local $mc_t19_f64 f64)(local $mc_t16_f64 f64)(local $mc_t14_f64 f64)(local $mc_t12_f64 f64)(local $mc_t17_f64 f64)(local $i_f64 f64)(local $mc_t9_f64 f64)(local $mc_t7_f64 f64)(local $mc_t5_f64 f64)(local $mc_t30_i32 i32)(local $mc_t32_i32 i32)(local $mc_t34_i32 i32)(local $mc_t37_i32 i32)(local $mc_t40_i32 i32)(local $mc_t43_i32 i32)(local $mc_t45_i32 i32)(local $mc_t48_i32 i32)(local $mc_t51_i32 i32)(local $mc_t54_i32 i32)(local $mc_t56_i32 i32)(local $mc_t59_i32 i32)
		get_local $A_i32
        call $mxarray_core_get_array_ptr
		set_local $A_i32_ptr
		get_local $A_i32
