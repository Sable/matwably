...
;; Array Operations
   ...
   (export "power_SM" (func $power_SM))
	...
	(func $f2_S (param $c_f64 f64)
		(local $mc_t1_f64 f64)(local $a_f64 f64)(local $b_f64 f64)(local $mc_t2_f64 f64)(local $mc_t7_f64 f64)(local $mc_t4_f64 f64)(local $mc_t5_f64 f64)(local $mc_t6_f64 f64)
		f64.const 3.0
		set_local $a_f64
		f64.const 5.0
		set_local $b_f64
