...
;; Array Operations
   ...
   (export "power_SM" (func $power_SM))
	...
	(func $f3_S (param $a_f64 f64)
		(local $mc_t0_f64 f64)(local $a_f64 f64)(local $mc_t3_f64 f64)(local $mc_t2_f64 f64)(local $mc_t6_i32 i32)(local $mc_t5_i32 i32)
		i32.const 2
		i32.const 0
		i32.const 0
		i32.const 0
