...
)(func $merge_op2_S (param $g_f64 f64)
	(local $mc_t0_f64 f64)(local $mc_t10_f64 f64)(local $mc_t8_f64 f64)(local $A_i32 i32)(local $mc_t11_f64 f64)(local $mc_t4_f64 f64)(local $mc_t6_f64 f64)(local $C_i32 i32)(local $mc_t2_i32 i32)(local $mc_t3_f64 f64)(local $mc_t7_i32 i32)(local $mc_t12_f64 f64)(local $mc_t9_f64 f64)(local $mc_t5_f64 f64)(local $mc_t14_i32 i32)(local $mc_t15_f64 f64)
	f64.const 2.0
	f64.const 2.0
	call $ones_2D
	set_local $A_i32
...
(export "merge_op2_S" (func $merge_op2_S ) )
