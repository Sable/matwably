...
(func $gcRecordFreeing (param i32)
...
)(func $merge_op3_S (param $s_f64 f64)
	(local $mc_t0_f64 f64)(local $mc_t10_f64 f64)(local $mc_t13_f64 f64)(local $A_i32 i32)(local $mc_t2_f64 f64)(local $mc_t11_f64 f64)(local $mc_t4_f64 f64)(local $mc_t8_i32 i32)(local $mc_t6_f64 f64)(local $C_i32 i32)(local $mc_t9_f64 f64)(local $mc_t7_f64 f64)(local $mc_t12_i32 i32)(local $mc_t5_f64 f64)(local $mc_t15_i32 i32)(local $mc_t16_f64 f64)(local $mc_t14_i32 i32)
	f64.const 2.0
	f64.const 2.0
	call $ones_2D
	set_local $C_i32
	...
	get_global $STACKTOP
	tee_local $mc_t14_i32
	i32.const 0
	i32.store
	get_local $mc_t14_i32
	get_local $A_i32
	call $gcCheckReturnFlagToFreeSite
	get_local $mc_t14_i32
	get_local $C_i32
	call $gcCheckReturnFlagToFreeSite
	call $gcPrintMemoryUsageInformation
	return
)
(export "merge_op3_S" (func $merge_op3_S ) )
