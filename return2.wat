...
(func $gcRecordFreeing (param i32)
	...
	(local $mc_t21_f64 f64)(local $mc_t23_i32 i32)(local $mc_t24_f64 f64)
	get_local $e_f64
...
(func $return1_helper_S (param $e_f64 f64)(result i32)
	(local $a_f64 f64)(local $b_f64 f64)(local $c_f64 f64)(local $mc_t25_i32 i32)(local $mc_t26_f64 f64)(local $mc_t27_i32 i32)
	f64.const 3.0
	set_local $a_f64
	f64.const 10.0
	set_local $b_f64
