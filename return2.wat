...
(func $return2_S (param $e_f64 f64)
	(local $mc_t1033_f64 f64)(local $mc_t1035_i32 i32)(local $mc_t1036_f64 f64)
	get_local $e_f64
	call $return1_helper_S
	set_local $mc_t1033_f64
	get_local $mc_t1033_f64
	call $disp_S
	return
)
(func $return1_helper_S (param $e_f64 f64)(result i32)
	(local $a_f64 f64)(local $b_f64 f64)(local $c_f64 f64)(local $mc_t1037_i32 i32)(local $mc_t1038_f64 f64)(local $mc_t1039_i32 i32)
	f64.const 3.0
	set_local $a_f64
	f64.const 10.0
	set_local $b_f64
	...
	i32.const 0
	call $create_mxvector
	set_local $mc_t1039_i32
	get_local $mc_t1039_i32
	i32.const 0
	get_local $a_f64
	call $set_array_index_f64_no_check
	get_local $mc_t1039_i32
...
(export "return2_S" (func $return2_S ) )
