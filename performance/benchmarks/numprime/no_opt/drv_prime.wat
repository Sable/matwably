...
;; Array Operations
   ...
   (export "power_SM" (func $power_SM))
	...
	(func $prime_total_S (param $n_f64 f64)(result f64)
		(local $total_f64 f64)(local $prime_f64 f64)(local $mc_t8_f64 f64)(local $i_f64 f64)(local $mc_t2_f64 f64)(local $mc_t7_f64 f64)(local $mc_t4_f64 f64)(local $j_f64 f64)(local $mc_t5_f64 f64)(local $mc_t6_f64 f64)(local $mc_t9_i32 i32)(local $mc_t12_i32 i32)
		f64.const 0.0
		set_local $total_f64
		f64.const 2.0
		set_local $mc_t8_f64
