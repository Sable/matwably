...
;; Array Operations
   ...
   (export "power_SM" (func $power_SM))
	...
	(func $drv_collatz_S (param $scale_f64 f64)(result f64)
		(local $mc_t1_f64 f64)(local $t_f64 f64)(local $max_num_f64 f64)(local $max_length_f64 f64)(local $i_f64 f64)(local $mc_t2_f64 f64)(local $length_f64 f64)(local $mc_t16_i32 i32)
		(local $y_f64 f64)
        call $tic
		drop
		loop $loop_mc_t17
	...
	(func $collatz_S (param $i_f64 f64)(result f64)
		(local $y_f64 f64)
		    loop $loop_mc_t19
        block $block_mc_t20
				get_local $i_f64
