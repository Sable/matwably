...
)(func $merge_op_S (param $A_f64 f64)
	(local $mc_t0_f64 f64)(local $mc_t13_i32 i32)(local $B_i32 i32)(local $A_i32 i32)(local $mc_t2_f64 f64)(local $mc_t11_f64 f64)(local $mc_t4_f64 f64)(local $mc_t8_i32 i32)(local $mc_t6_f64 f64)(local $mc_t14_f64 f64)(local $mc_t12_f64 f64)(local $mc_t9_f64 f64)(local $mc_t7_f64 f64)(local $mc_t5_f64 f64)(local $mc_t17_i32 i32)(local $mc_t18_f64 f64)(local $mc_t16_i32 i32)
	f64.const 2.0
	f64.const 2.0
	call $ones_2D
	set_local $A_i32
...
(export "merge_op_S" (func $merge_op_S ) )
