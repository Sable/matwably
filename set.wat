...
(func $gcRecordFreeing (param i32)
	...
	(local $mc_t803_f64 f64)(local $mc_t808_f64 f64)(local $mc_t816_f64 f64)(local $mc_t819_f64 f64)(local $mc_t820_f64 f64)(local $mc_t798_i32 i32)(local $mc_t805_f64 f64)(local $mc_t818_f64 f64)(local $mc_t801_f64 f64)(local $mc_t799_i32 i32)(local $mc_t814_f64 f64)(local $mc_t810_f64 f64)(local $mc_t812_f64 f64)(local $mc_t797_i32 i32)(local $mc_t809_f64 f64)(local $mc_t802_f64 f64)(local $mc_t821_f64 f64)(local $mc_t800_f64 f64)(local $b_i32 i32)(local $mc_t817_f64 f64)(local $mc_t811_f64 f64)(local $mc_t813_f64 f64)(local $mc_t823_i32 i32)(local $mc_t824_f64 f64)(local $mc_t825_i32 i32)(local $mc_t829_i32 i32)(local $mc_t827_i32 i32)(local $mc_t826_i32 i32)(local $mc_t830_i32 i32)(local $mc_t832_i32 i32)(local $mc_t831_i32 i32)(local $mc_t833_i32 i32)(local $mc_t834_i32 i32)(local $mc_t837_i32 i32)(local $mc_t835_i32 i32)(local $mc_t838_i32 i32)(local $mc_t836_i32 i32)(local $mc_t840_i32 i32)(local $mc_t841_i32 i32)(local $mc_t842_i32 i32)(local $mc_t839_i32 i32)
	i32.const 3
	i32.const 0
	i32.const 0
	i32.const 0
	call $create_mxvector
	set_local $mc_t825_i32
	get_local $mc_t825_i32
	i32.const 0
	f64.const 3.0
	call $set_array_index_f64_no_check
	get_local $mc_t825_i32
	...
	call $disp_M
	f64.const 2.0
	set_local $mc_t805_f64
	i32.const 1
	i32.const 5
	i32.const 0
	i32.const 0
	call $create_mxvector
	set_local $mc_t826_i32
	f64.const 1.0
	f64.const 42
	call $colon_two
	set_local $mc_t827_i32
	get_local $mc_t827_i32
	tee_local $mc_t828_i32
	call $transpose_M
	set_local $mc_t827_i32
	get_local $mc_t826_i32
	i32.load offset=8 align=4
	i32.const 0
	i32.const 2
	i32.shl
	...
	i32.const 0
	call $create_mxvector
	set_local $mc_t829_i32
	get_local $b_i32
	get_local $mc_t826_i32
	get_local $mc_t829_i32
	i32.load offset=8 align=4
	i32.const 0
	i32.const 3
	i32.shl
	i32.add
	get_local $mc_t805_f64
	f64.store offset=0 align=8
	get_local $mc_t829_i32
	call $set_f64
	get_local $mc_t826_i32
	call $free_macharray
	get_local $mc_t828_i32
	call $free_macharray
	get_local $mc_t827_i32
	call $free_macharray
	get_local $mc_t829_i32
	...
	i32.const 0
	call $create_mxvector
	set_local $mc_t830_i32
	get_local $mc_t830_i32
	i32.load offset=8 align=4
	i32.const 0
	i32.const 3
	i32.shl
	...
	f64.store offset=0 align=8
	get_local $mc_t830_i32
	set_local $mc_t797_i32
	f64.const 2.0
	set_local $mc_t811_f64
	f64.const 2.0
	set_local $mc_t812_f64
	i32.const 3
	i32.const 5
	i32.const 0
	i32.const 0
	call $create_mxvector
	set_local $mc_t831_i32
	f64.const 1.0
	f64.const 3
	call $colon_two
	set_local $mc_t832_i32
	get_local $mc_t831_i32
	i32.load offset=8 align=4
	i32.const 0
	i32.const 2
	i32.shl
	i32.add
	get_local $mc_t832_i32
	i32.store offset=0 align=4
	i32.const 1
	i32.const 0
	i32.const 0
	i32.const 0
	call $create_mxvector
	set_local $mc_t833_i32
	i32.const 1
	i32.const 0
	i32.const 0
	i32.const 0
	call $create_mxvector
	set_local $mc_t834_i32
	get_local $b_i32
	get_local $mc_t833_i32
	i32.load offset=8 align=4
	i32.const 0
	i32.const 3
	i32.shl
	i32.add
	get_local $mc_t811_f64
	f64.store offset=0 align=8
	get_local $mc_t831_i32
	i32.load offset=8 align=4
	i32.const 1
	...
	get_local $mc_t833_i32
	i32.store offset=0 align=4
	get_local $mc_t834_i32
	i32.load offset=8 align=4
	i32.const 0
	i32.const 3
	i32.shl
	i32.add
	get_local $mc_t812_f64
	f64.store offset=0 align=8
	get_local $mc_t831_i32
	i32.load offset=8 align=4
	i32.const 2
	...
	call $free_macharray
	f64.const 2.0
	set_local $mc_t813_f64
	f64.const 2.0
	set_local $mc_t814_f64
	i32.const 3
	i32.const 5
	i32.const 0
	i32.const 0
	call $create_mxvector
	set_local $mc_t835_i32
	f64.const 1.0
	f64.const 3
	call $colon_two
	set_local $mc_t836_i32
	get_local $mc_t835_i32
	i32.load offset=8 align=4
	i32.const 0
	i32.const 2
	i32.shl
	i32.add
	get_local $mc_t836_i32
	i32.store offset=0 align=4
	i32.const 1
	i32.const 0
	i32.const 0
	i32.const 0
	call $create_mxvector
	set_local $mc_t837_i32
	i32.const 1
	i32.const 0
	i32.const 0
	i32.const 0
	call $create_mxvector
	set_local $mc_t838_i32
	get_local $b_i32
	get_local $mc_t837_i32
	i32.load offset=8 align=4
	i32.const 0
	i32.const 3
	i32.shl
	i32.add
	get_local $mc_t813_f64
	f64.store offset=0 align=8
	get_local $mc_t835_i32
	i32.load offset=8 align=4
	i32.const 1
	...
	get_local $mc_t837_i32
	i32.store offset=0 align=4
	get_local $mc_t838_i32
	i32.load offset=8 align=4
	i32.const 0
	i32.const 3
	i32.shl
	i32.add
	get_local $mc_t814_f64
	f64.store offset=0 align=8
	get_local $mc_t835_i32
	i32.load offset=8 align=4
	i32.const 2
	...
	call $end
	call $colon_two
	set_local $mc_t798_i32
	f64.const 3.0
	set_local $mc_t819_f64
	f64.const 1.0
	set_local $mc_t820_f64
	f64.const 1.0
	set_local $mc_t821_f64
	i32.const 3
	i32.const 5
	i32.const 0
	i32.const 0
	call $create_mxvector
	set_local $mc_t839_i32
	i32.const 1
	i32.const 0
	i32.const 0
	i32.const 0
	call $create_mxvector
	set_local $mc_t840_i32
	i32.const 1
	i32.const 0
	i32.const 0
	i32.const 0
	call $create_mxvector
	set_local $mc_t841_i32
	i32.const 1
	i32.const 0
	i32.const 0
	i32.const 0
	call $create_mxvector
	set_local $mc_t842_i32
	get_local $b_i32
	get_local $mc_t839_i32
	i32.load offset=8 align=4
	i32.const 0
	i32.const 2
	i32.shl
	i32.add
	get_local $mc_t798_i32
	i32.store offset=0 align=4
	get_local $mc_t840_i32
	i32.load offset=8 align=4
	i32.const 0
	i32.const 3
	i32.shl
	i32.add
	get_local $mc_t820_f64
	f64.store offset=0 align=8
	get_local $mc_t839_i32
	i32.load offset=8 align=4
	i32.const 1
	...
	get_local $mc_t840_i32
	i32.store offset=0 align=4
	get_local $mc_t841_i32
	i32.load offset=8 align=4
	i32.const 0
	i32.const 3
	i32.shl
	i32.add
	get_local $mc_t821_f64
	f64.store offset=0 align=8
	get_local $mc_t839_i32
	i32.load offset=8 align=4
	i32.const 2
	...
	i32.store offset=0 align=4
	get_local $mc_t839_i32
	get_local $mc_t842_i32
	i32.load offset=8 align=4
	i32.const 0
	i32.const 3
	i32.shl
	i32.add
	get_local $mc_t819_f64
	f64.store offset=0 align=8
	get_local $mc_t842_i32
	call $set_f64
	get_local $mc_t839_i32
