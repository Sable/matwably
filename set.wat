...
(func $set_S (param $size_f64 f64)(result i32)
	(local $mc_t1220_f64 f64)(local $mc_t1225_f64 f64)(local $mc_t1210_f64 f64)(local $mc_t1221_f64 f64)(local $mc_t1208_f64 f64)(local $mc_t1228_f64 f64)(local $mc_t1206_i32 i32)(local $mc_t1217_f64 f64)(local $mc_t1219_f64 f64)(local $mc_t1218_f64 f64)(local $mc_t1213_f64 f64)(local $mc_t1205_i32 i32)(local $mc_t1229_f64 f64)(local $mc_t1211_f64 f64)(local $mc_t1226_f64 f64)(local $mc_t1224_f64 f64)(local $mc_t1222_f64 f64)(local $mc_t1207_i32 i32)(local $mc_t1227_f64 f64)(local $b_i32 i32)(local $mc_t1216_f64 f64)(local $mc_t1209_f64 f64)(local $mc_t1231_i32 i32)(local $mc_t1232_f64 f64)(local $mc_t1233_i32 i32)(local $mc_t1234_i32 i32)(local $mc_t1237_i32 i32)(local $mc_t1235_i32 i32)(local $mc_t1238_i32 i32)(local $mc_t1240_i32 i32)(local $mc_t1241_i32 i32)(local $mc_t1242_i32 i32)(local $mc_t1239_i32 i32)(local $mc_t1243_i32 i32)(local $mc_t1244_i32 i32)(local $mc_t1245_i32 i32)(local $mc_t1246_i32 i32)(local $mc_t1249_i32 i32)(local $mc_t1250_i32 i32)(local $mc_t1248_i32 i32)(local $mc_t1247_i32 i32)
	i32.const 3
	i32.const 0
	i32.const 0
	i32.const 0
	call $create_mxvector
	set_local $mc_t1233_i32
	get_local $mc_t1233_i32
	i32.const 0
	f64.const 3.0
	call $set_array_index_f64_no_check
	get_local $mc_t1233_i32
	...
	call $disp_M
	f64.const 2.0
	set_local $mc_t1213_f64
	i32.const 1
	i32.const 5
	i32.const 0
	i32.const 0
	call $create_mxvector
	set_local $mc_t1234_i32
	f64.const 1.0
	f64.const 42
	call $colon_two
	set_local $mc_t1235_i32
	get_local $mc_t1235_i32
	tee_local $mc_t1236_i32
	call $transpose_M
	set_local $mc_t1235_i32
	get_local $mc_t1234_i32
	i32.load offset=8 align=4
	i32.const 0
	i32.const 2
	i32.shl
	...
	i32.const 0
	call $create_mxvector
	set_local $mc_t1237_i32
	get_local $b_i32
	get_local $mc_t1234_i32
	get_local $mc_t1237_i32
	i32.load offset=8 align=4
	i32.const 0
	i32.const 3
	i32.shl
	i32.add
	get_local $mc_t1213_f64
	f64.store offset=0 align=8
	get_local $mc_t1237_i32
	call $set_f64
	get_local $mc_t1234_i32
	call $free_macharray
	get_local $mc_t1236_i32
	call $free_macharray
	get_local $mc_t1235_i32
	call $free_macharray
	get_local $mc_t1237_i32
	...
	i32.const 0
	call $create_mxvector
	set_local $mc_t1238_i32
	get_local $mc_t1238_i32
	i32.load offset=8 align=4
	i32.const 0
	i32.const 3
	i32.shl
	...
	f64.store offset=0 align=8
	get_local $mc_t1238_i32
	set_local $mc_t1205_i32
	f64.const 2.0
	set_local $mc_t1219_f64
	f64.const 2.0
	set_local $mc_t1220_f64
	i32.const 3
	i32.const 5
	i32.const 0
	i32.const 0
	call $create_mxvector
	set_local $mc_t1239_i32
	f64.const 1.0
	f64.const 3
	call $colon_two
	set_local $mc_t1240_i32
	get_local $mc_t1239_i32
	i32.load offset=8 align=4
	i32.const 0
	i32.const 2
	i32.shl
	i32.add
	get_local $mc_t1240_i32
	i32.store offset=0 align=4
	i32.const 1
	i32.const 0
	i32.const 0
	i32.const 0
	call $create_mxvector
	set_local $mc_t1241_i32
	i32.const 1
	i32.const 0
	i32.const 0
	i32.const 0
	call $create_mxvector
	set_local $mc_t1242_i32
	get_local $b_i32
	get_local $mc_t1241_i32
	i32.load offset=8 align=4
	i32.const 0
	i32.const 3
	i32.shl
	i32.add
	get_local $mc_t1219_f64
	f64.store offset=0 align=8
	get_local $mc_t1239_i32
	i32.load offset=8 align=4
	i32.const 1
	...
	get_local $mc_t1241_i32
	i32.store offset=0 align=4
	get_local $mc_t1242_i32
	i32.load offset=8 align=4
	i32.const 0
	i32.const 3
	i32.shl
	i32.add
	get_local $mc_t1220_f64
	f64.store offset=0 align=8
	get_local $mc_t1239_i32
	i32.load offset=8 align=4
	i32.const 2
	...
	call $free_macharray
	f64.const 2.0
	set_local $mc_t1221_f64
	f64.const 2.0
	set_local $mc_t1222_f64
	i32.const 3
	i32.const 5
	i32.const 0
	i32.const 0
	call $create_mxvector
	set_local $mc_t1243_i32
	f64.const 1.0
	f64.const 3
	call $colon_two
	set_local $mc_t1244_i32
	get_local $mc_t1243_i32
	i32.load offset=8 align=4
	i32.const 0
	i32.const 2
	i32.shl
	i32.add
	get_local $mc_t1244_i32
	i32.store offset=0 align=4
	i32.const 1
	i32.const 0
	i32.const 0
	i32.const 0
	call $create_mxvector
	set_local $mc_t1245_i32
	i32.const 1
	i32.const 0
	i32.const 0
	i32.const 0
	call $create_mxvector
	set_local $mc_t1246_i32
	get_local $b_i32
	get_local $mc_t1245_i32
	i32.load offset=8 align=4
	i32.const 0
	i32.const 3
	i32.shl
	i32.add
	get_local $mc_t1221_f64
	f64.store offset=0 align=8
	get_local $mc_t1243_i32
	i32.load offset=8 align=4
	i32.const 1
	...
	get_local $mc_t1245_i32
	i32.store offset=0 align=4
	get_local $mc_t1246_i32
	i32.load offset=8 align=4
	i32.const 0
	i32.const 3
	i32.shl
	i32.add
	get_local $mc_t1222_f64
	f64.store offset=0 align=8
	get_local $mc_t1243_i32
	i32.load offset=8 align=4
	i32.const 2
	...
	call $end
	call $colon_two
	set_local $mc_t1206_i32
	f64.const 3.0
	set_local $mc_t1227_f64
	f64.const 1.0
	set_local $mc_t1228_f64
	f64.const 1.0
	set_local $mc_t1229_f64
	i32.const 3
	i32.const 5
	i32.const 0
	i32.const 0
	call $create_mxvector
	set_local $mc_t1247_i32
	i32.const 1
	i32.const 0
	i32.const 0
	i32.const 0
	call $create_mxvector
	set_local $mc_t1248_i32
	i32.const 1
	i32.const 0
	i32.const 0
	i32.const 0
	call $create_mxvector
	set_local $mc_t1249_i32
	i32.const 1
	i32.const 0
	i32.const 0
	i32.const 0
	call $create_mxvector
	set_local $mc_t1250_i32
	get_local $b_i32
	get_local $mc_t1247_i32
	i32.load offset=8 align=4
	i32.const 0
	i32.const 2
	i32.shl
	i32.add
	get_local $mc_t1206_i32
	i32.store offset=0 align=4
	get_local $mc_t1248_i32
	i32.load offset=8 align=4
	i32.const 0
	i32.const 3
	i32.shl
	i32.add
	get_local $mc_t1228_f64
	f64.store offset=0 align=8
	get_local $mc_t1247_i32
	i32.load offset=8 align=4
	i32.const 1
	...
	get_local $mc_t1248_i32
	i32.store offset=0 align=4
	get_local $mc_t1249_i32
	i32.load offset=8 align=4
	i32.const 0
	i32.const 3
	i32.shl
	i32.add
	get_local $mc_t1229_f64
	f64.store offset=0 align=8
	get_local $mc_t1247_i32
	i32.load offset=8 align=4
	i32.const 2
	...
	i32.store offset=0 align=4
	get_local $mc_t1247_i32
	get_local $mc_t1250_i32
	i32.load offset=8 align=4
	i32.const 0
	i32.const 3
	i32.shl
	i32.add
	get_local $mc_t1227_f64
	f64.store offset=0 align=8
	get_local $mc_t1250_i32
	call $set_f64
	get_local $mc_t1247_i32
