...
;; Array Operations
   ...
   (export "power_SM" (func $power_SM))
	...
	(func $literals_S (param $a_f64 f64)
		(local $mc_t1_f64 f64)(local $mc_t0_i32 i32)(local $mc_t3_i32 i32)(local $b_i32 i32)(local $mc_t2_f64 f64)(local $mc_t4_f64 f64)(local $mc_t5_f64 f64)(local $mc_t7_i32 i32)(local $mc_t9_i32 i32)(local $mc_t8_i32 i32)(local $mc_t12_i32 i32)(local $mc_t11_i32 i32)(local $mc_t10_i32 i32)(local $mc_t13_i32 i32)
		f64.const 1.0
		set_local $mc_t1_f64
		f64.const 2.0
		set_local $mc_t2_f64
	...
	(export "literals_S" (func $literals_S ) )
)
